...
public class SimNavigationTargets {
   ...
   public static final Supplier<RecoveryCompassNavigationTarget> RECOVERY_COMPASS = REGISTRATE.navTarget(
      "recovery_compass", RecoveryCompassNavigationTarget::new, Items.RECOVERY_COMPASS
   );
