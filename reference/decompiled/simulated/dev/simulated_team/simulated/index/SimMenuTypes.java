...
public class SimMenuTypes {
   public static final MenuEntry<LinkedTypewriterMenuCommon> LINKED_TYPEWRITER = register(
      "linked_typewriter", SimMenuService.INSTANCE::getLoaderLinkedTypewriter, () -> LinkedTypewriterScreen::new
   );
