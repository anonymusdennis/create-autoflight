...
public class SimResourceManagers {
   public static SimpleResourceManager<SimulatedSection> SIMULATED_SECTION = SimpleResourceManager.<SimulatedSection>create(
         SimulatedSection.CODEC, Simulated.path("sections")
      )
      .sorted();
