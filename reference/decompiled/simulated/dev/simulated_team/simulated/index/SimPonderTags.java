...
public class SimPonderTags {
   ...
   public static void register(PonderTagRegistrationHelper<ResourceLocation> helper) {
      ...
      helper.registerTag(THRUST_PRODUCING_BLOCKS)
         ...
         .register();
      itemHelper.addToTag(THRUST_PRODUCING_BLOCKS).add(AllBlocks.ENCASED_FAN.asItem()).add(AllBlocks.NOZZLE.asItem());
      ...
      itemHelper.addToTag(AllCreatePonderTags.KINETIC_SOURCES).add(SimBlocks.STEERING_WHEEL.asItem()).add(SimBlocks.RED_PORTABLE_ENGINE.asItem());
      itemHelper.addToTag(AllCreatePonderTags.KINETIC_APPLIANCES).add(SimBlocks.SWIVEL_BEARING.asItem()).add(SimBlocks.ROPE_WINCH.asItem());
      itemHelper.addToTag(AllCreatePonderTags.FLUIDS).add(SimBlocks.DOCKING_CONNECTOR.asItem());
      ...
      itemHelper.addToTag(AllCreatePonderTags.MOVEMENT_ANCHOR).add(SimBlocks.PHYSICS_ASSEMBLER.asItem()).add(SimBlocks.SWIVEL_BEARING.asItem());
      itemHelper.addToTag(AllCreatePonderTags.SAILS).add(SimBlocks.WHITE_SYMMETRIC_SAIL.asItem());
      itemHelper.addToTag(AllCreatePonderTags.ARM_TARGETS).add(SimBlocks.RED_PORTABLE_ENGINE.asItem()).add(SimBlocks.NAVIGATION_TABLE.asItem());
      itemHelper.addToTag(AllCreatePonderTags.DISPLAY_SOURCES)
         ...
         .add(SimBlocks.DOCKING_CONNECTOR.asItem())
         .add(SimBlocks.LINKED_TYPEWRITER.asItem());
      itemHelper.addToTag(AllCreatePonderTags.DISPLAY_TARGETS).add(SimBlocks.NAMEPLATES.get(DyeColor.WHITE).asItem());
      itemHelper.addToTag(AllCreatePonderTags.THRESHOLD_SWITCH_TARGETS).add(SimBlocks.ROPE_WINCH.asItem());
   }
}
