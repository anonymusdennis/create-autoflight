...
public record SearchAlias(List<String> terms, List<TagOrElementLocation> results) {
   ...
   public static final Codec<SearchAlias> CODEC = RecordCodecBuilder.create(
   ...
   public boolean match(ItemStack stack) {
      for (TagOrElementLocation result : this.results()) {
         if (result.tag()) {
