...
public class ComputerCraftPeripherals implements SimModCompatibilityService {
   ...
   public void init() {
      ...
      service.addWired(
         SimBlockEntityTypes.DOCKING_CONNECTOR,
         (blockEntity, direction) -> blockEntity.getBlockState().getValue(DockingConnectorBlock.FACING) == direction
               ? null
               : (WiredElement)blockEntity.ccWiredElement
      );
   }
