...
public class MagnetFieldParticleData2 implements ParticleOptions, ICustomParticleDataWithSprite<MagnetFieldParticleData2> {
   public static final MapCodec<MagnetFieldParticleData2> CODEC = RecordCodecBuilder.mapCodec(
   ...
   public static final StreamCodec<ByteBuf, MagnetFieldParticleData2> STREAM_CODEC = StreamCodec.composite(
   ...
   public SpriteParticleRegistration<MagnetFieldParticleData2> getMetaFactory() {
