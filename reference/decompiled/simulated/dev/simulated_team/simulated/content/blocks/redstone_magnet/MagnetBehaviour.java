...
public class MagnetBehaviour extends BlockEntityBehaviour {
   ...
   public void tick() {
      super.tick();
      if (!this.getWorld().isClientSide) {
         SimMovementContext context = SimMovementContext.getMovementContext(this.getWorld(), Vec3.atCenterOf(this.blockEntity.getBlockPos()));
         SectionPos newSection = SectionPos.of(context.globalPosition());
   ...
   private SectionPos getCurrentSection() {
      SimMovementContext context = SimMovementContext.getMovementContext(this.blockEntity.getLevel(), Vec3.atCenterOf(this.blockEntity.getBlockPos()));
