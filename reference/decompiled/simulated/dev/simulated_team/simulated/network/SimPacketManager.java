...
public class SimPacketManager {
   public static final VeilPacketManager INSTANCE = VeilPacketManager.create("simulated", "0.1");
   ...
   public static void init() {
      ...
      INSTANCE.registerServerbound(
         ConfigureModulatingLinkedRecieverPacket.TYPE, ConfigureModulatingLinkedRecieverPacket.CODEC, SimBlockEntityConfigurationPacket::handle
      );
      ...
      INSTANCE.registerClientbound(
         PhysicsAssemblerFlickAndHoldLeverPacket.TYPE, PhysicsAssemblerFlickAndHoldLeverPacket.CODEC, PhysicsAssemblerFlickAndHoldLeverPacket::handle
      );
      INSTANCE.registerClientbound(
         ClientboundPlayersHoldingHandlePacket.TYPE, ClientboundPlayersHoldingHandlePacket.CODEC, ClientboundPlayersHoldingHandlePacket::handle
      );
      ...
      INSTANCE.registerClientbound(
         UpdateClientLodestonePositionPacket.TYPE, UpdateClientLodestonePositionPacket.STREAM_CODEC, UpdateClientLodestonePositionPacket::handle
      );
   }
}
