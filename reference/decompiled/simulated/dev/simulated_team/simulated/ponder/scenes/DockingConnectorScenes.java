...
public class DockingConnectorScenes {
   public static void DockingConnector(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      for (ElementLink<WorldSectionElement> section : cartSections) {
         world.rotateSection(section, 0.0, 60.0, 0.0, 0);
         world.moveSection(section, new Vec3(-1.0, 0.0, 3.0), 0);
      }
      ...
      for (ElementLink<WorldSectionElement> section : cartSections) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(section, new Vec3(0.0, 0.0, -3.0), 30, SmoothMovementUtils.cubicSmoothing()));
         scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(section, new Vec3(0.0, -60.0, 0.0), 30, SmoothMovementUtils.cubicSmoothing()));
      }

      scene.idle(15);

      for (ElementLink<WorldSectionElement> section : cartSections) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(section, new Vec3(1.0, 0.0, 0.0), 20, SmoothMovementUtils.quadraticRise()));
      }
      ...
      world.moveSection(hammer, new Vec3(0.0, 0.0, -2.0), 0);
      world.rotateSection(hammer, -60.0, 0.0, 0.0, 0);
      scene.idle(10);
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(hammer, new Vec3(60.0, 0.0, 0.0), 20, SmoothMovementUtils.quadraticRise()));
      scene.idle(20);
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(hammer, new Vec3(-10.0, 0.0, 0.0), 10, SmoothMovementUtils.quadraticRiseDual()));
      scene.idle(10);
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(hammer, new Vec3(10.0, 0.0, 0.0), 20, SmoothMovementUtils.cubicSmoothing()));
      scene.idle(15);
      overlay.showText(60)
         .pointAt(new Vec3(7.0, 3.5, 5.5))
         .attachKeyFrame()
      ...
      scene.world()
         .modifyBlockEntity(
            new BlockPos(11, 1, 4), FluidTankBlockEntity.class, be -> be.getTankInventory().fill(new FluidStack(Fluids.LAVA, 12000), FluidAction.EXECUTE)
         );
      scene.idle(10);
      ...
      for (ElementLink<WorldSectionElement> section : cartSections) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(section, new Vec3(-1.5, 0.0, 0.0), 20, SmoothMovementUtils.cubicSmoothing()));
      }
      ...
      for (ElementLink<WorldSectionElement> section : cartSections) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(section, new Vec3(1.5, 0.0, 0.0), 40, SmoothMovementUtils.cubicSmoothing()));
      }
