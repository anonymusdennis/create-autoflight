...
public class AeroLevititeBlendPropagationContexts {
   public static RegistryObject<CrystalPropagationContext> STANDARD_CONTEXT = create("standard", LevititeCrystalPropagationContext::new);
   public static RegistryObject<CrystalPropagationContext> SOUL_CONTEXT = create("soul", LevititeSoulCrystalPropagationContext::new);
