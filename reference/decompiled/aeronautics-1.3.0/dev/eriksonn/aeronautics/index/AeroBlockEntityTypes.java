...
public class AeroBlockEntityTypes {
   ...
   public static final BlockEntityEntry<SteamVentBlockEntity> STEAM_VENT = REGISTRATE.blockEntity("steam_vent", SteamVentBlockEntity::new)
      .validBlocks(new NonNullSupplier[]{AeroBlocks.STEAM_VENT})
      .renderer(() -> SteamVentRenderer::new)
      .register();
   public static final BlockEntityEntry<HotAirBurnerBlockEntity> HOT_AIR_BURNER = REGISTRATE.blockEntity("adjustable_burner", HotAirBurnerBlockEntity::new)
      .validBlocks(new NonNullSupplier[]{AeroBlocks.HOT_AIR_BURNER})
      .renderer(() -> HotAirBurnerRenderer::new)
      .register();
   public static final BlockEntityEntry<PropellerBearingBlockEntity> PROPELLER_BEARING = REGISTRATE.blockEntity(
         "propeller_bearing", PropellerBearingBlockEntity::new
      )
      .visual(() -> PropellerBearingVisual::new)
      .validBlocks(new NonNullSupplier[]{AeroBlocks.PROPELLER_BEARING})
      .renderer(() -> PropellerBearingRenderer::new)
      .register();
   public static final BlockEntityEntry<GyroscopicPropellerBearingBlockEntity> GYROSCOPIC_PROPELLER_BEARING = REGISTRATE.blockEntity(
         "gyroscopic_propeller_bearing", GyroscopicPropellerBearingBlockEntity::new
      )
      .visual(() -> GyroscopicPropellerBearingVisual::new)
      .validBlocks(new NonNullSupplier[]{AeroBlocks.GYROSCOPIC_PROPELLER_BEARING})
      .renderer(() -> GyroscopicPropellerBearingRenderer::new)
      .register();
   public static final BlockEntityEntry<KineticBlockEntity> ENVELOPE_ENCASED_SHAFT = REGISTRATE.blockEntity("envelope_encased_shaft", KineticBlockEntity::new)
      .visual(() -> SingleAxisRotatingVisual::shaft, false)
      .validBlocks(AeroBlocks.ENVELOPE_ENCASED_SHAFTS.toArray())
      .renderer(() -> ShaftRenderer::new)
      .register();
   public static final BlockEntityEntry<AndesitePropellerBlockEntity> ANDESITE_PROPELLER = REGISTRATE.blockEntity(
         "andesite_propeller", AndesitePropellerBlockEntity::new
      )
      .visual(() -> AndesitePropellerVisual::new, false)
      .validBlocks(new NonNullSupplier[]{AeroBlocks.ANDESITE_PROPELLER})
      .renderer(() -> AndesitePropellerRenderer::new)
      .register();
   public static final BlockEntityEntry<WoodenPropellerBlockEntity> WOODEN_PROPELLER = REGISTRATE.blockEntity(
         "wooden_propeller", WoodenPropellerBlockEntity::new
      )
      .visual(() -> WoodenPropellerVisual::new, false)
      .renderer(() -> WoodenPropellerRenderer::new)
      .validBlocks(new NonNullSupplier[]{AeroBlocks.WOODEN_PROPELLER})
      .register();
   public static final BlockEntityEntry<SmartPropellerBlockEntity> SMART_PROPELLER = REGISTRATE.blockEntity("smart_propeller", SmartPropellerBlockEntity::new)
      .renderer(() -> SmartPropellerRenderer::new)
      .validBlocks(new NonNullSupplier[]{AeroBlocks.SMART_PROPELLER})
      .register();
   public static final BlockEntityEntry<MountedPotatoCannonBlockEntity> MOUNTED_POTATO_CANNON = ((BlockEntityBuilder)REGISTRATE.blockEntity(
            "mounted_potato_cannon", MountedPotatoCannonBlockEntity::new
         )
         .visual(() -> MountedPotatoCannonVisual::new)
         .onRegister(SimInventoryService.INSTANCE.registerInventory((be, dir) -> be.getInventory())))
      .validBlocks(new NonNullSupplier[]{AeroBlocks.MOUNTED_POTATO_CANNON})
