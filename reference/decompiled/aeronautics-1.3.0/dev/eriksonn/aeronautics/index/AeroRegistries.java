...
public class AeroRegistries {
   ...
   public static final RegistrationProvider<CrystalPropagationContext> LEVITITE_CRYSTAL_PROPAGATION_CONTEXT = registry(
      AeroRegistries.Keys.LEVITITE_CRYSTAL_PROPAGATION_CONTEXT
   );

   private static <T> RegistrationProvider<T> registry(ResourceKey<Registry<T>> registryKey) {
      return RegistrationProvider.get(registryKey, "aeronautics");
   }
