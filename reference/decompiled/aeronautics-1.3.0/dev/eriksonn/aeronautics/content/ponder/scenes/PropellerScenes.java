...
import dev.simulated_team.simulated.ponder.SceneScheduler.Sequence;
...
public class PropellerScenes {
   public static void propellerBearingSize(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(5);
      ElementLink<WorldSectionElement> propellerCenterSection = world.showIndependentSection(select.position(propellerPos.above()), Direction.DOWN);
      scene.idle(5);
      List<ElementLink<WorldSectionElement>> sails = new ArrayList<>();

      for (int i = 0; i < 4; i++) {
         Direction dir = Direction.fromYRot((double)(i * 90));
         Vec3i pos = dir.getNormal().offset(0, 2, 0);
         ElementLink<WorldSectionElement> currentSail = world.showIndependentSection(select.position(propellerPos.offset(pos)), dir.getOpposite());
      ...
      scene.idle(65);
      PropellerRotateInstruction propellerRotation = new PropellerRotateInstruction(propellerPos, propellerCenterSection, Direction.UP, -32.0F, 4.0F);
      scene.addInstruction(propellerRotation);

      for (ElementLink<WorldSectionElement> sail : sails) {
         scene.addInstruction(new ChangePropellerRotateInstruction.AddSection(propellerRotation, sail));
      }

      scene.addInstruction(new ChangePropellerRotateInstruction.SetParticles(propellerRotation, null, 1.5F, -5.0F, 1.5F, false));
      scene.idle(10);
      ElementLink<ParrotElement> flappyBirb = special.createBirb(vector.topOf(propellerPos.above()), FlappyPose::new);
      scene.idle(2);
      TickingInstruction[] parrotInstructions = new TickingInstruction[]{
         AnimateParrotInstruction.rotate(flappyBirb, new Vec3(0.0, -4300.0, 0.0), 1000), new CustomParrotFlappingInstruction(flappyBirb, 1.0F, 1000)
      };
      ...
      for (int var30 = 0; var30 < 4; var30++) {
         Direction dir = Direction.fromYRot((double)(var30 * 90));
         BlockPos base = propellerPos.offset(0, 1, 0);
         Vec3i pos1 = dir.getNormal();
         Vec3i pos2 = dir.getNormal().cross(new Vec3i(0, -1, 0));
         ElementLink<WorldSectionElement> currentSupport = world.showIndependentSection(
            select.fromTo(base.offset(pos1), base.offset(pos1.multiply(2))), dir.getOpposite()
         );
         ElementLink<WorldSectionElement> currentSail = world.showIndependentSection(
            select.fromTo(base.offset(pos1.offset(pos2)), base.offset(pos1.multiply(3).offset(pos2))), dir.getOpposite()
         );
         sails.add(currentSail);
         world.configureCenterOfRotation(currentSail, Vec3.atCenterOf(propellerPos));
      ...
      scene.idle(3);
      scene.addInstruction(new ChangePropellerRotateInstruction.SetParticles(propellerRotation, null, 5.0F, -5.0F, 3.5F, false));
      ...
      scene.idle(3);
      overlay.chaseBoundingBoxOutline(PonderPalette.WHITE, bb, bb.expandTowards(0.0, 6.0, 0.0), 70);
      scene.addInstruction(new AirflowAABBInstruction(PonderPalette.WHITE, bb.expandTowards(0.0, 6.0, 0.0), 70, Direction.UP, 5.0F, 3.0F));
      overlay.showText(65)
         .pointAt(new Vec3(0.0, 4.0, 2.5))
         .attachKeyFrame()
         .placeNearTarget()
      ...
      for (int var32 = 0; var32 < 4; var32++) {
         Direction dir = Direction.fromYRot((double)(var32 * 90));
         BlockPos base = propellerPos.offset(0, 2, 0);
         Vec3i pos1 = dir.getNormal();
         Vec3i pos2 = dir.getNormal().cross(new Vec3i(0, -1, 0));
         ElementLink<WorldSectionElement> currentSail = world.showIndependentSection(
            select.fromTo(base.offset(pos1.offset(pos2)), base.offset(pos1.multiply(3).offset(pos2))), dir.getClockWise()
         );
         sails.add(currentSail);
         world.moveSection(currentSail, new Vec3(0.0, -1.0, 0.0), 0);
         world.configureCenterOfRotation(currentSail, Vec3.atCenterOf(propellerPos));
      ...
      scene.idle(100);
      scene.addInstruction(new ChangePropellerRotateInstruction.StopRotation(propellerRotation, 30.0F));
      scene.idle(10);

      for (int var33 = 0; var33 < 2; var33++) {
         scene.addInstruction(new TickingStoppingInstruction(parrotInstructions[var33]));
      }
   ...
   public static void propellerBearingThrust(SceneBuilder builder, SceneBuildingUtil util, boolean smolPropeller) {
      ...
      ElementLink<WorldSectionElement> ground = world.showIndependentSection(select.fromTo(0, 0, 0, 11, 0, 11), Direction.UP);
      scene.idle(10);
      ElementLink<WorldSectionElement> airship = world.showIndependentSection(select.fromTo(3, 3, 7, 10, 3, 11), Direction.DOWN);
      scene.idle(2);
      ElementLink<WorldSectionElement> airshipSmall = world.showIndependentSection(select.fromTo(4, 4, 2, 6, 4, 2), Direction.DOWN);
      SceneScheduler sceneScheduler = new SceneScheduler(scene);
      Sequence seq1 = sceneScheduler.get(0);
      Sequence seq2 = sceneScheduler.get(1);
      ...
      sceneScheduler.run();
      scene.idle(2);
      ElementLink<WorldSectionElement> propeller = world.showIndependentSection(select.fromTo(2, 2, 7, 2, 6, 11), Direction.EAST);
      ...
      scene.idle(5);
      ElementLink<ParrotElement> flappyBird = special.createBirb(new Vec3(7.5, 4.5, 9.5), FacePointOfInterestPose::new);
      ...
      scene.addInstruction(new SetPropellerSailsInstruction(propellerPos, 8.0F));
      PropellerRotateInstruction propellerRotation = new PropellerRotateInstruction(propellerPos, propeller, Direction.WEST, -32.0F, 8.0F);
      scene.addInstruction(propellerRotation);
      scene.addInstruction(new ChangePropellerRotateInstruction.SetParticles(propellerRotation, airship, 2.0F, -6.0F, 2.0F, false));
      scene.idle(10);
      AABB[] bbs = new AABB[]{
         new AABB(new Vec3(2.5, 4.5, 0.5), new Vec3(2.5, 4.5, 0.5)).inflate(0.0, 1.0, 1.0),
         new AABB(new Vec3(2.5, 4.5, 4.5), new Vec3(2.5, 4.5, 4.5)).inflate(0.0, 1.0, 1.0),
         new AABB(new Vec3(2.5, 4.5, 9.5), new Vec3(2.5, 4.5, 9.5)).inflate(0.0, 2.5, 2.5)
      };
      AABB[] bbs2 = new AABB[]{
         new AABB(new Vec3(2.5, 4.5, 4.0), new Vec3(2.5, 4.5, 4.0)).inflate(0.0, 1.0, 1.0),
         new AABB(new Vec3(2.5, 4.5, 8.0), new Vec3(2.5, 4.5, 8.0)).inflate(0.0, 1.0, 1.0),
         new AABB(new Vec3(2.5, 4.5, 6.0), new Vec3(2.5, 4.5, 6.0)).inflate(0.0, 2.5, 2.5)
      };
      ...
      for (int i = 0; i < bbs.length; i++) {
         ...
         scene.addInstruction(
            new AirflowAABBInstruction(
               PonderPalette.WHITE, bb.expandTowards(-bbInfo[i].x, 0.0, 0.0), 90, Direction.WEST, (float)bbInfo[i].y, (float)bbInfo[i].z
            )
         );
      }

      TickingInstruction propParticles1 = new PropellerParticleSpawningInstruction(
         airshipSmall, new BlockPos(2, 4, 0), Direction.WEST, 1000, 1.0F, 5.0F, 1.0F, false
      );
      scene.addInstruction(propParticles1);
      TickingInstruction propParticles2 = new PropellerParticleSpawningInstruction(
         airshipSmall, new BlockPos(2, 4, 4), Direction.WEST, 1000, 1.0F, 5.0F, 1.0F, false
      );
      ...
      if (smolPropeller) {
         ...
         scene.addInstruction(new ChangePropellerRotateInstruction.StopRotation(propellerRotation, 20.0F));
      } else {
      ...
      for (ElementLink<WorldSectionElement> shipPiece : shipPieces) {
         scene.addInstruction(
            CustomAnimateWorldSectionInstruction.move(shipPiece, new Vec3(0.0, 0.0, smolPropeller ? 3.5 : -3.5), 20, SmoothMovementUtils.cubicSmoothing())
         );
      }
      ...
      for (ElementLink<WorldSectionElement> shipPiece : shipPieces) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(shipPiece, new Vec3(4.0, 0.0, 0.0), 70, SmoothMovementUtils.cubicSmoothing()));
      }

      scene.idle(60);
      scene.world().multiplyKineticSpeed(select.everywhere(), -1.0F);
      if (!smolPropeller) {
         scene.addInstruction(new ChangePropellerRotateInstruction.SetRotationRate(propellerRotation, 32.0F));
      } else {
         scene.addInstruction(new TickingStoppingInstruction(propParticles1));
         propParticles1 = new PropellerParticleSpawningInstruction(airshipSmall, new BlockPos(2, 4, 0), Direction.EAST, 1000, 1.0F, 5.0F, 1.0F, false);
         scene.addInstruction(propParticles1);
         scene.addInstruction(new TickingStoppingInstruction(propParticles2));
         propParticles2 = new PropellerParticleSpawningInstruction(airshipSmall, new BlockPos(2, 4, 4), Direction.EAST, 1000, 1.0F, 5.0F, 1.0F, false);
         scene.addInstruction(propParticles2);
      }
      ...
      overlay.showText(60)
         .placeNearTarget()
         .attachKeyFrame()
         .pointAt(pointingPos.add(4.0, 0.0, 0.0))
      ...
      for (int i : currentBBSelection) {
         scene.addInstruction(
            new AirflowAABBInstruction(
               PonderPalette.WHITE,
               bbs2[i].move(4.0, 0.0, 0.0).expandTowards(bbInfo[i].x, 0.0, 0.0),
               60,
               Direction.EAST,
               (float)bbInfo[i].y,
               (float)bbInfo[i].z,
      ...
      for (ElementLink<WorldSectionElement> shipPiece : shipPieces) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(shipPiece, new Vec3(-3.0, 0.0, 0.0), 70, SmoothMovementUtils.cubicSmoothing()));
      }

      scene.idle(80);
      pointingPos = pointingPos.add(1.0, 0.0, 0.0);
      if (smolPropeller) {
         overlay.showText(60).placeNearTarget().pointAt(pointingPos).attachKeyFrame().text("The Thrust can also be reversed using a wrench");
         scene.idle(20);
         overlay.showControls(pointingPos.add(-0.5, -0.5, -4.0), Pointing.LEFT, 20).withItem(AllItems.WRENCH.asStack());
         scene.idle(10);
         scene.addInstruction(new TickingStoppingInstruction(propParticles1));
         propParticles1 = new PropellerParticleSpawningInstruction(airshipSmall, new BlockPos(2, 4, 0), Direction.WEST, 1000, 1.0F, 5.0F, 1.0F, false);
         scene.addInstruction(propParticles1);
         scene.addInstruction(new TickingStoppingInstruction(propParticles2));
         propParticles2 = new PropellerParticleSpawningInstruction(airshipSmall, new BlockPos(2, 4, 4), Direction.WEST, 1000, 1.0F, 5.0F, 1.0F, false);
         scene.addInstruction(propParticles2);
         scene.world()
            .modifyBlocks(
               select.fromTo(2, 4, 0, 2, 4, 4),
               state -> state.hasProperty(BasePropellerBlock.REVERSED) ? (BlockState)state.setValue(BasePropellerBlock.REVERSED, true) : state,
               false
            );
      } else {
         Vec3 configBox = pointingPos.add(0.1, 0.0, 0.0);
         ...
         overlay.showText(60).placeNearTarget().pointAt(configBox).attachKeyFrame().text("The Thrust can also be reversed using the value box");
         scene.idle(20);
      ...
      for (int i : currentBBSelection) {
         scene.addInstruction(
            new AirflowAABBInstruction(
               PonderPalette.WHITE,
               bbs2[i].move(1.0, 0.0, 0.0).expandTowards(-bbInfo[i].x, 0.0, 0.0),
               60,
               Direction.WEST,
               (float)bbInfo[i].y,
               (float)bbInfo[i].z,
      ...
      scene.idle(30);
      float movementDistance = 53.0F;
      int movementDuration = 353;
      scene.addInstruction(new CustomToggleBaseShadowInstruction());
      scene.addInstruction(
         CustomAnimateWorldSectionInstruction.move(ground, new Vec3(-53.0, 0.0, 0.0), movementDuration, SmoothMovementUtils.asymptoticAcceleration(15.0F))
      );
      ElementLink<WorldSectionElement> ground2 = world.showIndependentSection(select.fromTo(12, 0, 2, 55, 1, 9), Direction.WEST);
      scene.addInstruction(
         CustomAnimateWorldSectionInstruction.move(ground2, new Vec3(-53.0, 0.0, 0.0), movementDuration, SmoothMovementUtils.asymptoticAcceleration(15.0F))
      );
      scene.idle(40);
      movementDuration -= 40;
      ...
      for (int i : currentBBSelection) {
         AABB bb = bbs2[i].move(1.0, 0.0, 0.0);
         overlay.chaseBoundingBoxOutline(PonderPalette.WHITE, bb, bb, 3);
      }
      ...
      for (int i : currentBBSelection) {
         AABB bb = bbs2[i].move(1.0, 0.0, 0.0);
         overlay.chaseBoundingBoxOutline(PonderPalette.WHITE, bb, bb.expandTowards(-6.0, 0.0, 0.0), 210);
         scene.addInstruction(new AirflowAABBInstruction(PonderPalette.WHITE, bb.expandTowards(-6.0, 0.0, 0.0), 120, Direction.WEST, 5.0F, 2.0F, true, true));
      }
      ...
      scene.idle(1);
      overlay.chaseBoundingBoxOutline(PonderPalette.BLUE, bb1, bb1.expandTowards(-15.0, 0.0, 0.0), 175);
      overlay.chaseBoundingBoxOutline(PonderPalette.BLUE, bb2, bb2.expandTowards(-15.0, 0.0, 0.0), 175);
      scene.idle(5);
      scene.addInstruction(new AirflowAABBInstruction(PonderPalette.BLUE, bb1.expandTowards(-15.0, 0.0, 0.0), 170, Direction.WEST, 3.15F, 3.0F, false, false));
      scene.addInstruction(new AirflowAABBInstruction(PonderPalette.BLUE, bb2.expandTowards(-15.0, 0.0, 0.0), 170, Direction.WEST, 3.15F, 3.0F, false, false));
      scene.idle(10);
      movementDuration -= 16;
      ...
      for (int i : currentBBSelection) {
         AABB bb = bbs2[i].move(1.0, 0.0, 0.0);
         scene.addInstruction(new AirflowAABBInstruction(PonderPalette.RED, bb.expandTowards(-6.0, 0.0, 0.0), 90, Direction.WEST, 5.0F, 4.0F, true, false));
      }
      ...
      ElementLink<WorldSectionElement> ground3 = world.showIndependentSection(select.fromTo(0, 0, 0, 11, 0, 11), null);
      ...
      for (ElementLink<WorldSectionElement> shipPiece : shipPieces) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(shipPiece, new Vec3(-2.0, 0.0, 0.0), 60, SmoothMovementUtils.cubicSmoothing()));
      }

      scene.idle(20);
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(ground3, new Vec3(-3.0, 0.0, 0.0), 40, SmoothMovementUtils.quadraticRiseDual()));
      scene.idle(25);
      scene.addInstruction(new CustomToggleBaseShadowInstruction());
   }
   ...
   public static void gyroBearingStabilize(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      overlay.showOutlineWithText(select.position(propellerPos), 70)
         ...
         .pointAt(Vec3.atCenterOf(propellerPos).add(0.0, 0.0, 0.5))
         .placeNearTarget();
      scene.idle(60);
      float revolutions = 2.5F;
      int duration = (int)(36.0F * revolutions);
      PropellerRotateInstruction propellerRotate = new PropellerRotateInstruction(propellerPos, propellerSection, Direction.UP, 32.0F, 8.0F);
      scene.addInstruction(propellerRotate);
      scene.addInstruction(new ChangePropellerRotateInstruction.SetParticles(propellerRotate, propellerSection, 4.0F, -5.0F, 3.0F, false));
      ...
      scene.idle(10);
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(ship, new Vec3(0.0, 0.0, 160.0), 70, SmoothMovementUtils.quadraticRise()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(propellerSection, new Vec3(0.0, 0.0, 160.0), 70, SmoothMovementUtils.quadraticRise()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(ship, new Vec3(0.0, 2.5, 0.0), 40, SmoothMovementUtils.cubicSmoothing()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(propellerSection, new Vec3(0.0, 2.5, 0.0), 40, SmoothMovementUtils.cubicSmoothing()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(ship, new Vec3(-12.0, 0.0, 0.0), 70, SmoothMovementUtils.cubicRise()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(propellerSection, new Vec3(-12.0, 0.0, 0.0), 70, SmoothMovementUtils.cubicRise()));
      scene.idle(40);
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(ship, new Vec3(0.0, -3.0, 0.0), 30, SmoothMovementUtils.quadraticRise()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(propellerSection, new Vec3(0.0, -3.0, 0.0), 30, SmoothMovementUtils.quadraticRise()));
      scene.idle(10);
      ...
      ElementLink<WorldSectionElement> bearingSection = world.showIndependentSection(select.position(propellerPos), Direction.DOWN);
      ...
      overlay.showOutlineWithText(select.position(propellerPos.west()), 70)
         ...
         .attachKeyFrame()
         .colored(PonderPalette.GREEN)
         .pointAt(Vec3.atCenterOf(propellerPos.west()).add(0.0, 0.0, 0.5))
         .placeNearTarget();
      scene.idle(60);
      revolutions = 7.0F;
      duration = (int)(36.0F * revolutions);
      propellerRotate = new PropellerRotateInstruction(propellerPos, propellerSection, Direction.UP, 32.0F, 8.0F);
      scene.addInstruction(propellerRotate);
      scene.addInstruction(
         new ChangePropellerRotateInstruction.SetParticles(propellerRotate, propellerPos.west().above(), propellerSection, 4.0F, -5.0F, 3.0F, false)
      );
      scene.idle(10);
      ElementLink<WorldSectionElement>[] allSections = new ElementLink[]{ship, bearingSection, propellerSection, chainSection};
      ElementLink<WorldSectionElement>[] nonPropellerSections = new ElementLink[]{ship, bearingSection, chainSection};
      scene.idle(30);
      duration -= 40;
      Vec3 totalMotion = new Vec3(-0.5, 1.5, 0.0);

      for (ElementLink<WorldSectionElement> section : allSections) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(section, totalMotion, 40, SmoothMovementUtils.cubicSmoothing()));
      }

      Vec3 pivotPoint = Vec3.atCenterOf(propellerPos).add(-1.0, 0.25, 0.0);

      for (ElementLink<WorldSectionElement> section : nonPropellerSections) {
         world.configureCenterOfRotation(section, pivotPoint);
         scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(section, new Vec3(0.0, 0.0, 10.0), 40, SmoothMovementUtils.cubicSmoothing()));
      }

      scene.addInstruction(new CustomGyroBearingTiltInstruction(ship, propellerPos, 50, true));
      world.configureCenterOfRotation(bearingSection, Vec3.atCenterOf(propellerPos).add(0.0, 0.25, 0.0));
      scene.idle(45);
      duration -= 45;
      ...
      scene.idle(3);
      duration -= 3;
      overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, bb, bb.inflate(3.0, 0.0, 3.0), 100);
      ...
      double h2 = -0.35;
      double h3 = -2.5;
      Vector3d[] lines = new Vector3d[]{
         new Vector3d(-1.5, -0.25, -1.5),
         new Vector3d(-1.5, -0.25, 1.5),
         new Vector3d(-1.5, -0.25, 1.5),
         new Vector3d(1.5, -0.25, 1.5),
         new Vector3d(1.5, -0.25, 1.5),
         ...
         new Vector3d(1.5, -0.25, -1.5),
         new Vector3d(-1.5, -0.25, -1.5),
         new Vector3d(-1.5, -0.35, -1.5),
         new Vector3d(-1.5, -2.5, -1.5),
         new Vector3d(-1.5, -0.35, 1.5),
         new Vector3d(-1.5, -2.5, 1.5),
         new Vector3d(1.5, -0.35, -1.5),
         new Vector3d(1.5, -2.5, -1.5),
      ...
      for (int i = 0; i < lines.length; i += 2) {
         overlay.showBigLine(PonderPalette.RED, JOMLConversion.toMojang(lines[i]), JOMLConversion.toMojang(lines[i + 1]), 100);
      }
      ...
      overlay.showText(80)
         ...
         .pointAt(pivotPoint.add(totalMotion).add(-0.501, 0.75, 0.0))
         .placeNearTarget();
      scene.idle(60);
      scene.addInstruction(new RotateSceneInstruction(-35.0F, -35.0F, true));
      scene.idle(50);
      ...
      for (ElementLink<WorldSectionElement> section : allSections) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(section, totalMotion.scale(-1.0), 40, SmoothMovementUtils.cubicSmoothing()));
      }
   ...
   public static void gyroBearingIsland(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(5);
      world.multiplyKineticSpeed(select.everywhere(), 1.0F);
      ElementLink<WorldSectionElement> propellerSection = world.showIndependentSection(select.layer(3), Direction.DOWN);
      world.moveSection(propellerSection, new Vec3(0.0, -1.0, 0.0), 0);
      BlockPos bearingPos = new BlockPos(4, 4, 4);
      scene.idle(4);
      Selection engineSection = select.position(3, 5, 5)
      ...
      ElementLink<WorldSectionElement> islandSection = world.showIndependentSection(select.position(bearingPos), Direction.DOWN);
      ...
      PropellerRotateInstruction propellerRotate = new PropellerRotateInstruction(bearingPos, propellerSection, Direction.DOWN, 32.0F, 16.0F);
      scene.addInstruction(propellerRotate);
      scene.addInstruction(new ChangePropellerRotateInstruction.SetParticles(propellerRotate, bearingPos.below(), propellerSection, 4.0F, 5.0F, 4.0F, true));
      scene.idle(3);
      ...
      ElementLink<ParrotElement> flappyBird = special.createBirb(new Vec3(1.5, 8.6, 1.5), FacePointOfInterestPose::new);
      special.movePointOfInterest(new Vec3(1000.0, 0.0, 6.0));
      ...
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(islandSection, new Vec3(0.0, 0.0, 4.0), 150, angleFunction));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(propellerSection, new Vec3(0.0, 0.0, 10.0), 150, angleFunction));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(islandSection, new Vec3(0.2, 0.0, 0.0), 150, angleFunction));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(propellerSection, new Vec3(0.2, 0.0, 0.0), 150, angleFunction));
      scene.idle(20);
      overlay.showText(60)
   ...
   public static void gyroBearingRedstone(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      ElementLink<WorldSectionElement> airship = world.showIndependentSection(
         util.select().fromTo(2, 1, 1, 7, 1, 7).substract(util.select().position(3, 1, 4)), Direction.DOWN
      );
      scene.idle(6);
      ...
      ElementLink<WorldSectionElement> valve = world.showIndependentSection(util.select().position(4, 2, 3), Direction.DOWN);
      scene.idle(4);
      world.showSectionAndMerge(
         util.select().fromTo(2, 2, 1, 6, 2, 7).substract(util.select().fromTo(3, 2, 2, 5, 2, 6)).substract(util.select().position(6, 2, 4)),
         Direction.DOWN,
         airship
      );
      scene.idle(4);
      ElementLink<WorldSectionElement> pivotSection = world.showIndependentSection(
         util.select().fromTo(3, 1, 4, 3, 3, 4).add(util.select().position(4, 2, 4)), Direction.DOWN
      );
      scene.idle(4);
      ElementLink<ParrotElement> flappyBird = scene.special().createBirb(new Vec3(5.5, 2.6, 4.5), FacePointOfInterestPose::new);
      ...
      scene.idle(4);
      ElementLink<WorldSectionElement> propellerSection = world.showIndependentSection(util.select().layer(4), Direction.DOWN);
      ElementLink<WorldSectionElement>[] allSections = new ElementLink[]{airship, valve, pivotSection, propellerSection};
      scene.idle(20);
      PropellerRotateInstruction propellerRotate = new PropellerRotateInstruction(bearingPos, propellerSection, Direction.UP, 32.0F, 8.0F);
      scene.addInstruction(propellerRotate);
      scene.addInstruction(new ChangePropellerRotateInstruction.SetParticles(propellerRotate, propellerSection, 3.0F, -4.0F, 2.5F, false));
      scene.idle(5);

      for (ElementLink<WorldSectionElement> section : allSections) {
         scene.addInstruction(CustomAnimateWorldSectionInstruction.move(section, new Vec3(0.0, 2.0, 0.0), 40, SmoothMovementUtils.cubicSmoothing()));
      }
      ...
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(valve, new Vec3(0.0, 90.0, 0.0), 30, SmoothMovementUtils.cubicSmoothing()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(propellerSection, new Vec3(0.0, 0.0, 90.0), 30, SmoothMovementUtils.cubicSmoothing()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.move(propellerSection, new Vec3(-1.0, 1.0, 0.0), 30, SmoothMovementUtils.cubicSmoothing()));
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(pivotSection, new Vec3(0.0, 0.0, 90.0), 30, SmoothMovementUtils.cubicSmoothing()));
      scene.idle(30);
      ...
      scene.addInstruction(CustomAnimateWorldSectionInstruction.rotate(propellerSection, new Vec3(0.0, 0.0, -12.0), 20, SmoothMovementUtils.linear()));
      scene.idle(10);
      scene.addInstruction(new RotateSceneInstruction(35.0F, 35.0F, true));
      scene.idle(10);
      overlay.showBigLine(
         ...
         new Vec3(1.25, 4.5, 4.5).add(new Vec3(-Math.cos(Math.toRadians(12.0)), Math.sin(Math.toRadians(12.0)), 0.0).scale(3.5)),
         135
      );
      scene.idle(10);
      overlay.showText(60)
