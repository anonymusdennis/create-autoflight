...
public class AeroFluidsNeoForge {
   ...
   public static final FluidEntry<Flowing> LEVITITE_BLEND = ((FluidBuilder)REGISTRATE.standardFluid(
            "levitite_blend",
            AeroFluidType.create(
               AeroColors.LEVIBLEND_THE_FOG_IS_COMING, () -> 0.03125F * AllConfigs.client().chocolateTransparencyMultiplier.getF(), LevititeBlendFluidType::new
            )
         )
         .lang("Levitite Blend")
         .properties(b -> b.viscosity(1500).density(1400).motionScale(-0.0023333333F).canSwim(false))
   ...
   public static void registerFluidInteractions() {
      InteractionInformation interaction = new InteractionInformation(
         LEVITITE_BLEND.getType(), fluidState -> fluidState.isSource() ? Blocks.OBSIDIAN.defaultBlockState() : Blocks.CALCITE.defaultBlockState()
      );
      FluidInteractionRegistry.addInteraction((FluidType)NeoForgeMod.LAVA_TYPE.value(), interaction);
   }
