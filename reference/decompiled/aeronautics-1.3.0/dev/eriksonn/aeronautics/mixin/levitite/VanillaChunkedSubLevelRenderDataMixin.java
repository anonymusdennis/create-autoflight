...
public class VanillaChunkedSubLevelRenderDataMixin {
   ...
   public void renderChunkedSubLevel(
      RenderType layer, ShaderInstance shader, Matrix4f modelView, double camX, double camY, double camZ, Operation<Void> original
   ) {
