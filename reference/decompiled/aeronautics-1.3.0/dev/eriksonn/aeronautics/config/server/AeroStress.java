...
public class AeroStress extends CStress {
   ...
   public void registerAll(Builder builder) {
      builder.comment(new String[]{".", AeroStress.Comments.su, AeroStress.Comments.impact}).push("impact");
      DEFAULT_IMPACTS.forEach((id, value) -> this.impacts.put(id, builder.define(id.getPath(), value)));
      builder.pop();
      builder.comment(new String[]{".", AeroStress.Comments.su, AeroStress.Comments.capacity}).push("capacity");
