...
public class StockTickerPeripheral extends SyncedPeripheral<StockTickerBlockEntity> {
   ...
   public final Map<Integer, Map<String, ?>> stock(Optional<Boolean> detailed) {
      ...
      for (BigItemStack entry : this.blockEntity.getAccurateSummary().getStacks()) {
         i++;
   ...
   public final Map<String, ?> getStockItemDetail(int slot) throws LuaException {
      return ComputerUtil.getItemDetail(this.blockEntity.getAccurateSummary(), slot);
   }
   ...
   public final int requestFiltered(String address, IArguments filters) throws LuaException {
      ...
      List<BigItemStack> stock = this.blockEntity.getAccurateSummary().getStacks();
      ...
      this.blockEntity.broadcastPackageRequest(LogisticallyLinkedBehaviour.RequestType.RESTOCK, order, null, address);
   ...
   public Map<Integer, Map<String, ?>> list() {
      return ComputerUtil.list(this.blockEntity.getReceivedPaymentsHandler());
   }
   ...
   public Map<String, ?> getItemDetail(int slot) throws LuaException {
      return ComputerUtil.getItemDetail(this.blockEntity.getReceivedPaymentsHandler(), slot);
   }
   ...
   public Object getTarget() {
      return this.blockEntity.getReceivedPaymentsHandler();
   }
}
