...
public class ComputerScreen extends AbstractSimiScreen {
   ...
   public ComputerScreen(
      Component title, @Nullable ComputerScreen.RenderWindowFunction additional, Screen previousScreen, Supplier<Boolean> hasAttachedComputer
   ) {
   ...
   public ComputerScreen(
      ...
      @Nullable ComputerScreen.RenderWindowFunction additional,
   ...
   public void tick() {
      if (!this.hasAttachedComputer.get()) {
   ...
   protected void init() {
      ...
      Mods.COMPUTERCRAFT.executeIfInstalled(() -> () -> {
            ...
            this.computerWidget.getToolTip().add(CreateLang.translate("gui.attached_computer.hint").component());
            this.addRenderableWidget(this.computerWidget);
         });
   ...
   protected void renderWindow(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
      ...
      graphics.drawString(
         this.font,
         this.displayTitle.get(),
         Math.round((float)x + (float)this.background.getWidth() / 2.0F - (float)this.font.width((FormattedText)this.displayTitle.get()) / 2.0F),
         y + 4,
         4464640,
         false
      );
      graphics.drawWordWrap(this.font, CreateLang.translate("gui.attached_computer.controlled").component(), x + 55, y + 32, 111, 8026746);
