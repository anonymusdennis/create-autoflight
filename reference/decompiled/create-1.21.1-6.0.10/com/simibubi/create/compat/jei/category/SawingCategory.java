...
public class SawingCategory extends CreateRecipeCategory<CuttingRecipe> {
   ...
   public void setRecipe(IRecipeLayoutBuilder builder, CuttingRecipe recipe, IFocusGroup focuses) {
      builder.addSlot(RecipeIngredientRole.INPUT, 44, 5).setBackground(getRenderedSlot(), -1, -1).addIngredients((Ingredient)recipe.getIngredients().get(0));
      ...
      for (ProcessingOutput output : results) {
         ...
         int yOffset = i / 2 * -19;
         ((IRecipeSlotBuilder)builder.addSlot(RecipeIngredientRole.OUTPUT, 118 + xOffset, 48 + yOffset)
