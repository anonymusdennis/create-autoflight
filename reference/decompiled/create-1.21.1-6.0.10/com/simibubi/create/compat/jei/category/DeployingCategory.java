...
public class DeployingCategory extends CreateRecipeCategory<DeployerApplicationRecipe> {
   ...
   public void setRecipe(IRecipeLayoutBuilder builder, DeployerApplicationRecipe recipe, IFocusGroup focuses) {
      ...
      IRecipeSlotBuilder handItemSlot = (IRecipeSlotBuilder)builder.addSlot(RecipeIngredientRole.INPUT, 51, 5)
      ...
      for (int i = 0; i < results.size(); i++) {
         ...
         int yOffset = i / 2 * -19;
         ((IRecipeSlotBuilder)builder.addSlot(RecipeIngredientRole.OUTPUT, single ? 132 : 132 + xOffset, 51 + yOffset)
      ...
      if (recipe.shouldKeepHeldItem()) {
         handItemSlot.addTooltipCallback(
