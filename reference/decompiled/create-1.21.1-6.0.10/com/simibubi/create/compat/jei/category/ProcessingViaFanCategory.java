...
public abstract class ProcessingViaFanCategory<T extends Recipe<?>> extends CreateRecipeCategory<T> {
   ...
   public void draw(T recipe, IRecipeSlotsView iRecipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
      ...
      AnimatedKinetics.defaultBlockElement(AllPartialModels.ENCASED_FAN_INNER)
         .rotateBlock(180.0, 0.0, (double)(AnimatedKinetics.getCurrentAngle() * 16.0F))
         .scale(24.0)
         .render(graphics);
   ...
   public abstract static class MultiOutput<T extends StandardProcessingRecipe<?>> extends ProcessingViaFanCategory<T> {
      ...
      public void setRecipe(IRecipeLayoutBuilder builder, T recipe, IFocusGroup focuses) {
         ...
         for (ProcessingOutput output : results) {
            ...
            ((IRecipeSlotBuilder)builder.addSlot(RecipeIngredientRole.OUTPUT, 141 + xOffset, 48 + yOffset)
