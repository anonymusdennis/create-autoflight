...
public enum AllRecipeTypes implements IRecipeTypeInfo, StringRepresentable {
   ...
   public static boolean shouldIgnoreInAutomation(RecipeHolder<?> recipe) {
      ...
      return serializer != null && AllTags.AllRecipeSerializerTags.AUTOMATION_IGNORE.matches(serializer) ? true : !CAN_BE_AUTOMATED.test(recipe);
   }
   ...
   private static class Registers {
      private static final DeferredRegister<RecipeSerializer<?>> SERIALIZER_REGISTER = DeferredRegister.create(BuiltInRegistries.RECIPE_SERIALIZER, "create");
