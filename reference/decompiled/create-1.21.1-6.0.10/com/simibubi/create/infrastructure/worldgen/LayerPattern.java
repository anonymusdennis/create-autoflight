...
public class LayerPattern {
   ...
   public static class Builder {
      ...
      public LayerPattern.Builder layer(Consumer<LayerPattern.Layer.Builder> builder) {
   ...
   public static class Layer {
      public static final Codec<LayerPattern.Layer> CODEC = RecordCodecBuilder.create(
         instance -> instance.group(
                  Codec.list(Codec.list(TargetBlockState.CODEC)).fieldOf("targets").forGetter(layer -> layer.targets),
               ...
               .apply(instance, LayerPattern.Layer::new)
      );
      ...
      public static class Builder {
         ...
         public LayerPattern.Layer.Builder blocks(Couple<NonNullSupplier<? extends Block>> blocksByDepth) {
            return this.blocks(
               ((Block)((NonNullSupplier)blocksByDepth.getFirst()).get()).defaultBlockState(),
               ((Block)((NonNullSupplier)blocksByDepth.getSecond()).get()).defaultBlockState()
            );
         }

         private LayerPattern.Layer.Builder blocks(BlockState stone, BlockState deepslate) {
            this.targets
               .add(ImmutableList.of(OreConfiguration.target(STONE_ORE_REPLACEABLES, stone), OreConfiguration.target(DEEPSLATE_ORE_REPLACEABLES, deepslate)));
            return this;
         }
