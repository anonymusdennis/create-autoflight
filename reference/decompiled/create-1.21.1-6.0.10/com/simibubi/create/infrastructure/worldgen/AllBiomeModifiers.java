...
public class AllBiomeModifiers {
   ...
   private static ResourceKey<BiomeModifier> key(String name) {
      return ResourceKey.create(Keys.BIOME_MODIFIERS, Create.asResource(name));
   }
   ...
   private static AddFeaturesBiomeModifier addOre(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) {
      return new AddFeaturesBiomeModifier(biomes, HolderSet.direct(new Holder[]{feature}), Decoration.UNDERGROUND_ORES);
   }
}
