...
public class FanScenes {
   ...
   public static void processing(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      ElementLink<EntityElement> entityLink = scene.world()
         .createItemEntity(util.vector().centerOf(blockPos.west(2).above(2)), util.vector().of(0.0, 0.1, 0.0), stack);
      scene.idle(15);
      ...
      scene.idle(20);
      scene.effects().emitParticles(itemVec.add(0.0, 0.2F, 0.0), scene.effects().simpleParticleEmitter(ParticleTypes.LARGE_SMOKE, Vec3.ZERO), 1.0F, 60);
      scene.overlay()
         .showText(80)
      ...
      scene.overlay().showControls(itemVec, Pointing.DOWN, 20).withItem(stack);
      scene.idle(20);
      scene.effects().emitParticles(itemVec.add(0.0, 0.2F, 0.0), scene.effects().simpleParticleEmitter(ParticleTypes.SPIT, Vec3.ZERO), 1.0F, 60);
      ...
      scene.idle(60);
      scene.effects().emitParticles(depotTop, scene.effects().simpleParticleEmitter(ParticleTypes.SPIT, Vec3.ZERO), 0.5F, 25);
      scene.idle(25);
