...
public class MechanicalSawScenes {
   public static void processing(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().setBlock(shaftPos, (BlockState)AllBlocks.SHAFT.getDefaultState().setValue(ShaftBlock.AXIS, Axis.Z), false);
      ...
      scene.world().modifyEntity(logItem, Entity::discard);
      scene.world().setBlock(shaftPos, (BlockState)AllBlocks.COGWHEEL.getDefaultState().setValue(ShaftBlock.AXIS, Axis.Z), true);
      scene.idle(3);
      scene.addKeyframe();
   ...
   public static void contraption(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world()
         .showSection(
            util.select().layer(0).add(util.select().position(3, 1, 1)).add(util.select().position(1, 1, 2)).add(util.select().position(2, 1, 4)), Direction.UP
         );
