...
public class AllCreatePonderTags {
   ...
   public static void register(PonderTagRegistrationHelper<ResourceLocation> helper) {
      PonderTagRegistrationHelper<RegistryEntry<?, ?>> HELPER = helper.withKeyFunction(DeferredHolder::getId);
      ...
      helper.registerTag(KINETIC_RELAYS)
         .addToIndex()
         .item((ItemLike)AllBlocks.COGWHEEL.get(), true, false)
      ...
      helper.registerTag(HIGH_LOGISTICS)
         .addToIndex()
         .item((ItemLike)AllBlocks.STOCK_TICKER.get(), true, false)
      ...
      helper.registerTag(CREATIVE)
         .addToIndex()
         .item((ItemLike)AllBlocks.CREATIVE_CRATE.get(), true, false)
         .title("Creative Mode")
         .description("Components not usually available for Survival Mode")
         .register();
      helper.registerTag(MOVEMENT_ANCHOR)
         .addToIndex()
         .item((ItemLike)AllBlocks.MECHANICAL_PISTON.get(), true, false)
      ...
      helper.registerTag(CONTRAPTION_ACTOR)
         .addToIndex()
         .item((ItemLike)AllBlocks.MECHANICAL_HARVESTER.get(), true, false)
      ...
      helper.registerTag(CONTRAPTION_ASSEMBLY)
         .addToIndex()
         .item((ItemLike)AllItems.SUPER_GLUE.get(), true, false)
      ...
      helper.registerTag(SAILS)
         .item((ItemLike)AllBlocks.WINDMILL_BEARING.get())
      ...
      helper.registerTag(ARM_TARGETS)
         .item((ItemLike)AllBlocks.MECHANICAL_ARM.get())
      ...
      helper.registerTag(TRAIN_RELATED)
         .addToIndex()
         .item((ItemLike)AllBlocks.TRACK.get(), true, false)
      ...
      helper.registerTag(DISPLAY_SOURCES)
         .item((ItemLike)AllBlocks.DISPLAY_LINK.get())
      ...
      helper.registerTag(THRESHOLD_SWITCH_TARGETS)
         .item((ItemLike)AllBlocks.THRESHOLD_SWITCH.get())
      ...
      HELPER.addToTag(ARM_TARGETS)
         ...
         .add(AllBlocks.CRUSHING_WHEEL)
         .add(AllBlocks.TRACK_STATION);
      itemHelper.addToTag(ARM_TARGETS).add(Blocks.COMPOSTER).add(Blocks.JUKEBOX).add(Blocks.CAMPFIRE).add(Blocks.SOUL_CAMPFIRE).add(Blocks.RESPAWN_ANCHOR);
