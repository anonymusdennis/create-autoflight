...
public class HosePulleyScenes {
   public static void intro(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(20);
      scene.world().modifyBlock(util.grid().at(3, 2, 1), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.DOWN), true);
   ...
   public static void level(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(55);
      scene.world().modifyBlock(util.grid().at(3, 2, 1), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.DOWN), false);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().of(0.0, 1.875, 1.5));
      scene.idle(30);
      scene.idle(30);
      ...
      scene.idle(15);
      scene.world().setKineticSpeed(kinetics, -32.0F);
      scene.world().modifyBlock(util.grid().at(3, 2, 1), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.UP), true);
      scene.world().propagatePipeChange(util.grid().at(3, 2, 1));
      scene.idle(16);
      scene.world().setKineticSpeed(kinetics, 0.0F);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().of(0.0, 3.875, 1.5));
      scene.idle(80);
   }
   ...
   public static void infinite(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().modifyBlock(pumpPos, s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.DOWN), true);
      ...
      scene.world()
         .modifyBlockEntity(
            util.grid().at(4, 1, 1), FluidTankBlockEntity.class, be -> be.getTankInventory().fill(new FluidStack(Fluids.WATER, 24000), FluidAction.EXECUTE)
         );
      scene.idle(20);
      scene.overlay()
         .showText(60)
