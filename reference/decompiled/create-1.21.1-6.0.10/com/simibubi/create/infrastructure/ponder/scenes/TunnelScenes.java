...
public class TunnelScenes {
   public static void andesite(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      for (int i = 0; i < 3; i++) {
         ...
         scene.world().moveSection(tunnels.get(i), util.vector().of(0.0, 0.0, -2.0), 0);
         scene.idle(4);
      }
      ...
      for (int i = 0; i < 3; i++) {
         ...
         scene.world()
            .modifyBlockEntityNBT(
               util.select().position(1 + i, 1, 2), BeltBlockEntity.class, nbt -> NBTHelper.writeEnum(nbt, "Casing", BeltBlockEntity.CasingType.ANDESITE), true
            );
         scene.idle(4);
      }
   ...
   public static void brass(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      for (int i = 0; i < 3; i++) {
         ...
         scene.world()
            .modifyBlockEntityNBT(
               util.select().position(2 + i, 1, 2), BeltBlockEntity.class, nbt -> NBTHelper.writeEnum(nbt, "Casing", BeltBlockEntity.CasingType.BRASS), true
            );
         scene.idle(4);
      }
   ...
   public static void brassModes(SceneBuilder builder, SceneBuildingUtil util) {
         ...
         if (i == 4) {
            ...
            scene.world()
               .modifyBlockEntity(
                  util.grid().at(1, 2, 3),
                  tunnelClass,
                  be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.FORCED_SPLIT.ordinal())
               );
         }
         ...
         if (i == 7) {
            scene.world()
               .modifyBlockEntity(
                  util.grid().at(1, 2, 3),
                  tunnelClass,
                  be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.ROUND_ROBIN.ordinal())
               );
         ...
         if (i == 15) {
            ...
            scene.world()
               .modifyBlockEntity(
                  util.grid().at(1, 2, 3),
                  tunnelClass,
                  be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.FORCED_ROUND_ROBIN.ordinal())
               );
         }
         ...
         if (i == 19) {
            ...
            scene.world()
               .modifyBlockEntity(
                  util.grid().at(1, 2, 3),
                  tunnelClass,
                  be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.PREFER_NEAREST.ordinal())
               );
            scene.world().moveSection(blockage, util.vector().of(1.0, 0.0, 0.0), 10);
            scene.world().setBlock(util.grid().at(1, 1, 0), barrier, false);
            scene.overlay()
         ...
         if (i == 26) {
            ...
            scene.world()
               .modifyBlockEntity(
                  util.grid().at(1, 2, 3),
                  tunnelClass,
                  be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.RANDOMIZE.ordinal())
               );
         }
      ...
      scene.world()
         .modifyBlockEntity(
            util.grid().at(1, 2, 3),
            tunnelClass,
            be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.SYNCHRONIZE.ordinal())
         );
      scene.idle(30);
