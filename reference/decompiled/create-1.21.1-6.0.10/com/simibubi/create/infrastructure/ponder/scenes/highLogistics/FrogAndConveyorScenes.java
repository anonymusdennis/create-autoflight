...
public class FrogAndConveyorScenes {
   public static void conveyor(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(1);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, conv1, bb1.inflate(1.0, 0.5, 1.0), 117);
      scene.idle(16);
      ...
      scene.idle(1);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, conv2, bb2.inflate(1.0, 0.5, 1.0), 100);
      scene.idle(10);
      ...
      FrogAndConveyorScenes.ChainConveyorParrotElement element = new FrogAndConveyorScenes.ChainConveyorParrotElement(parrotStart, FacePointOfInterestPose::new);
      ...
      scene.idle(20);
      scene.special().moveParrot(parrot, util.vector().of(-1.0, 0.0, -1.0), 14);
      scene.idle(14);
      scene.special().movePointOfInterest(util.grid().at(7, 3, 0));
      scene.special().moveParrot(parrot, util.vector().of(5.75, 0.0, -5.75), 90);
      scene.idle(65);
      scene.overlay()
         .showText(60)
      ...
      scene.special().moveParrot(parrot, util.vector().of(0.5, 0.0, 0.0), 6);
      scene.idle(6);
      scene.special().movePointOfInterest(util.grid().at(8, 3, 10));
      scene.special().moveParrot(parrot, util.vector().of(0.5, 0.0, 0.5), 14);
      scene.idle(14);
      scene.special().moveParrot(parrot, util.vector().of(0.0, 0.0, 7.0), 78);
      scene.idle(78);
   ...
   public static void frogPort(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(20);
      scene.overlay()
         .showOutlineWithText(util.select().position(fromFrog.below()).add(util.select().position(fromFrog.below().west())), 70)
      ...
      scene.idle(80);
      scene.overlay()
         .showControls(util.vector().blockSurface(util.grid().at(6, 1, 2), Direction.UP).add(0.5, 0.0, 0.0), Pointing.DOWN, 40)
      ...
      scene.idle(20);
      scene.overlay()
         .showControls(util.vector().blockSurface(util.grid().at(0, 1, 5), Direction.UP).add(0.5, 0.0, 0.0), Pointing.DOWN, 40)
         .withItem(new ItemStack(Items.DIAMOND));
      scene.idle(60);
   ...
   public static class ChainConveyorParrotElement extends ParrotElementImpl {
      ...
      protected void renderLast(PonderLevel world, MultiBufferSource buffer, GuiGraphics graphics, float fade, float pt) {
         ...
         if (this.wrench == null) {
            this.wrench = new ItemEntity(world, 0.0, 0.0, 0.0, AllItems.WRENCH.asStack());
            this.wrench.setYRot(this.wrench.yRotO = 180.0F);
         }

         double lx = Mth.lerp((double)pt, this.entity.xo, this.entity.getX());
         double ly = Mth.lerp((double)pt, this.entity.yo, this.entity.getY());
         double lz = Mth.lerp((double)pt, this.entity.zo, this.entity.getZ());
         ...
         poseStack.mulPose(Axis.ZP.rotationDegrees(Mth.sin(((float)world.scene.getCurrentTime() + pt) * 0.2F) * 10.0F));
         poseStack.translate(0.0F, -1.5F, 0.0F);
         poseStack.pushPose();
         ...
         BakedModel bakedmodel = Minecraft.getInstance().getItemRenderer().getModel(this.wrench.getItem(), world, null, 0);
