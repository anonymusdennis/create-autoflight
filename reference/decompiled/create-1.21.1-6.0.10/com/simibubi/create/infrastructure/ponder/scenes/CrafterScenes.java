...
public class CrafterScenes {
   public static void setup(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().modifyBlocks(crafters, s -> (BlockState)s.setValue(MechanicalCrafterBlock.POINTING, Pointing.DOWN), false);
      ...
      scene.overlay()
         ...
         .pointAt(util.vector().blockSurface(util.grid().at(1, 1, 2), Direction.WEST).add(0.0, 0.0, -0.5))
         .colored(PonderPalette.GREEN)
         .attachKeyFrame()
         .placeNearTarget();
      scene.idle(60);

      for (Couple<BlockPos> c : ImmutableList.of(
      ...
      scene.world()
         .multiplyKineticSpeed(
            util.select().position(3, 2, 2).add(util.select().position(2, 3, 2)).add(util.select().position(1, 2, 2)).add(util.select().position(2, 1, 2)),
            -1.0F
         );
      scene.idle(55);
      scene.rotateCameraY(-60.0F);
   ...
   public static void connect(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      BlockPos[] positions = new BlockPos[]{
         util.grid().at(2, 3, 2), util.grid().at(1, 3, 2), util.grid().at(1, 2, 2), util.grid().at(2, 1, 2), util.grid().at(1, 1, 2)
      };
   ...
   public static void covers(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(100);
      scene.overlay()
         .showControls(util.vector().blockSurface(util.grid().at(2, 2, 2), Direction.NORTH).add(0.5, 0.0, 0.0), Pointing.RIGHT, 50)
