...
public class RollerScenes {
   public static void clearAndPave(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(5);
      ElementLink<ParrotElement> birbLink = scene.special().createBirb(util.vector().centerOf(8, 3, 4), FacePointOfInterestPose::new);
      ...
      scene.overlay()
         .showText(60)
         .pointAt(filterSlot.add(-0.125, 0.0, 0.0))
         .attachKeyFrame()
   ...
   public static void fill(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(5);
      ElementLink<WorldSectionElement> trainLink = scene.world().showIndependentSection(train, Direction.DOWN);
      ElementLink<ParrotElement> birbLink = scene.special().createBirb(util.vector().centerOf(8, 7, 4), FacePointOfInterestPose::new);
      scene.idle(5);
      scene.world().showSectionAndMerge(rollers, Direction.EAST, trainLink);
      scene.idle(15);
