...
public class PackagerScenes {
   ...
   public static void packagerAddress(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .placeNearTarget()
         .pointAt(util.vector().blockSurface(util.grid().at(5, 1, 4), Direction.NORTH).add(-0.5, 0.0, 0.0));
      scene.idle(50);
      scene.overlay()
         .showText(60)
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().blockSurface(util.grid().at(3, 2, 4), Direction.NORTH).add(-0.5, 0.0, 0.0));
      scene.idle(120);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().of(4.0, 2.825, 4.5));
      scene.idle(70);
