...
public class PumpScenes {
   public static void flow(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().setBlock(pumpPos, ((FluidPipeBlock)AllBlocks.FLUID_PIPE.get()).getAxisState(Axis.X), false);
      ...
      scene.world().modifyBlock(pumpPos, s -> (BlockState)s.setValue(PumpBlock.FACING, ((Direction)s.getValue(PumpBlock.FACING)).getOpposite()), false);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().topOf(pumpPos).subtract(0.5, 0.125, 0.0));
      ...
      scene.idle(7);
      scene.world().modifyBlock(pumpPos, s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.EAST), true);
      scene.overlay()
         .showText(70)
         .attachKeyFrame()
   ...
   public static void speed(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().modifyBlock(pumpPos, s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.WEST), false);
      scene.world().modifyBlockEntity(util.grid().at(0, 1, 2), FluidTankBlockEntity.class, be -> be.getTankInventory().drain(3000, FluidAction.EXECUTE));
      ...
      scene.world().setBlock(east, (BlockState)AllBlocks.GLASS_FLUID_PIPE.getDefaultState().setValue(GlassFluidPipeBlock.AXIS, Axis.X), false);
      scene.world().setBlock(pumpPos.south(), (BlockState)AllBlocks.COGWHEEL.getDefaultState().setValue(CogWheelBlock.AXIS, Axis.X), false);
      ...
      scene.idle(60);
      BlockState pipeState = (BlockState)((BlockState)AllBlocks.FLUID_PIPE.getDefaultState().setValue(FluidPipeBlock.DOWN, false))
      ...
      scene.world()
         .setBlock(east.north(), (BlockState)((BlockState)pipeState.setValue(FluidPipeBlock.NORTH, false)).setValue(FluidPipeBlock.EAST, false), false);
      scene.world()
         .setBlock(east.south(), (BlockState)((BlockState)pipeState.setValue(FluidPipeBlock.SOUTH, false)).setValue(FluidPipeBlock.EAST, false), false);
      ...
      scene.world()
         .setBlock(west.north(), (BlockState)((BlockState)pipeState.setValue(FluidPipeBlock.NORTH, false)).setValue(FluidPipeBlock.WEST, false), false);
      scene.world()
         .setBlock(west.south(), (BlockState)((BlockState)pipeState.setValue(FluidPipeBlock.SOUTH, false)).setValue(FluidPipeBlock.WEST, false), false);
      ...
      scene.world().modifyBlock(pumpPos.south(), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.WEST), true);
      scene.world().setKineticSpeed(util.select().everywhere(), 0.0F);
      scene.world().showSection(northPump, Direction.DOWN);
      scene.world().modifyBlock(pumpPos.north(), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.EAST), false);
      scene.idle(4);
      ...
      scene.idle(7);
      scene.world().modifyBlock(pumpPos.north(), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.WEST), true);
      scene.idle(30);
      scene.overlay()
         .showText(70)
         .attachKeyFrame()
         .pointAt(util.vector().topOf(pumpPos.north()).subtract(0.5, 0.125, 0.0))
         .placeNearTarget()
