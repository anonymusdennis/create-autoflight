...
public class ElevatorScenes {
   public static void elevator(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world()
         .setBlock(
            topContact,
            (BlockState)((BlockState)AllBlocks.ELEVATOR_CONTACT.getDefaultState().setValue(ElevatorContactBlock.FACING, Direction.EAST))
      ...
      scene.world().setBlock(midContact, (BlockState)AllBlocks.ELEVATOR_CONTACT.getDefaultState().setValue(ElevatorContactBlock.FACING, Direction.EAST), false);
      scene.idle(15);
      ...
      scene.idle(10);
      scene.effects().indicateSuccess(util.grid().at(1, 2, 2));
      scene.world().setBlock(botContact, (BlockState)AllBlocks.ELEVATOR_CONTACT.getDefaultState().setValue(ElevatorContactBlock.FACING, Direction.EAST), false);
      scene.idle(5);
      ...
      scene.idle(90);
      scene.world()
         .setBlock(nixiePos, (BlockState)AllBlocks.NIXIE_TUBES.get(DyeColor.GREEN).getDefaultState().setValue(NixieTubeBlock.FACING, Direction.WEST), false);
