...
public class DisplayScenes {
   public static void link(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .pointAt(target.add(-1.0, 0.0, 0.0))
      ...
      scene.overlay()
         ...
         .pointAt(target.add(-2.45F, -0.5, 0.0))
         .attachKeyFrame()
         .placeNearTarget();
      scene.idle(30);
      scene.world().removeItemsFromBelt(depotPos);
      ...
      scene.world().setDisplayBoardText(board, 2, Component.literal("14 ").append(AllBlocks.COGWHEEL.asStack().getHoverName()));
      scene.world().flashDisplayLink(linkPos);
      scene.idle(40);
   ...
   public static void board(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .pointAt(target.add(-2.0, 0.0, 0.0))
         .attachKeyFrame()
         .placeNearTarget();
      scene.idle(80);
      scene.world().showSection(depot, Direction.DOWN);
   ...
   public static void redstone(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .colored(PonderPalette.GREEN)
         .attachKeyFrame()
         .pointAt(target.add(-2.45, -0.5, 0.0))
         .placeNearTarget()
