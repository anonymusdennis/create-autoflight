...
public class FactoryGaugeScenes {
   public static void restocker(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(7);
      setPanelItem(builder, gauge, FactoryPanelBlock.PanelSlot.TOP_RIGHT, monitorItem);
      scene.world().modifyBlockEntity(gauge, FactoryPanelBlockEntity.class, be -> {
         FactoryPanelBehaviour pb = be.panels.get(FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().of(3.0, 2.0, 1.5));
      scene.idle(100);
      ...
      scene.idle(7);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, gauge, boundingBox.move(0.0, 1.0, 0.0), 100);
      scene.overlay()
         .showText(100)
         ...
         .pointAt(gaugeMiddle);
      scene.idle(40);
      setPanelNotSatisfied(builder, gauge, FactoryPanelBlock.PanelSlot.TOP_RIGHT);
      scene.idle(70);
      scene.overlay()
         .showText(70)
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().of(3.0, 3.0, 1.5));
      scene.idle(50);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(util.vector().of(4.0, 2.5, 5.5));
      scene.idle(50);
      ...
      scene.idle(15);
      setPanelSatisfied(builder, gauge, FactoryPanelBlock.PanelSlot.TOP_RIGHT);
   }
   ...
   public static void recipe(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(10);
      setPanelVisible(builder, alloyG, FactoryPanelBlock.PanelSlot.TOP_RIGHT, false);
      setPanelPassive(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      removePanelConnections(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      setPanelItem(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, ItemStack.EMPTY);
      ...
      scene.overlay()
         ...
         .colored(PonderPalette.BLUE)
         .placeNearTarget()
         .pointAt(util.vector().of(4.0, 3.0, 7.0));
      scene.idle(110);
      ...
      scene.idle(7);
      setPanelItem(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, monitorItem);
      ...
      scene.idle(120);
      setPanelPassive(builder, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      removePanelConnections(builder, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      setPanelPassive(builder, nuggG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      removePanelConnections(builder, nuggG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .placeNearTarget()
         .pointAt(panelM.add(1.0, -0.5, 0.0));
      scene.idle(80);
      ...
      scene.idle(7);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, nuggG, boundingBox.move(1.0, -0.5, 0.0), 40);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, alloyG, boundingBox, 40);
      scene.idle(10);
      addPanelConnection(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, nuggG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      setArrowMode(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, nuggG, FactoryPanelBlock.PanelSlot.TOP_LEFT, 1);
      scene.idle(45);
      scene.overlay().showControls(panelM, Pointing.DOWN, 40).showing(AllIcons.I_ADD);
      scene.idle(50);
      scene.overlay().showControls(panelM.add(1.0, 0.0, 0.0), Pointing.DOWN, 50).rightClick();
      scene.idle(7);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, andeG, boundingBox.move(1.0, 0.0, 0.0), 40);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, alloyG, boundingBox, 40);
      scene.idle(10);
      addPanelConnection(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      scene.idle(45);
      scene.overlay()
         .showText(70)
      ...
      scene.idle(7);
      setArrowMode(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, nuggG, FactoryPanelBlock.PanelSlot.TOP_LEFT, 2);
      scene.idle(60);
      ...
      scene.overlay()
         ...
         .pointAt(panelM);
      scene.idle(110);
      setPanelNotSatisfied(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      scene.idle(20);
      scene.overlay()
      ...
      PonderHilo.packagerCreate(scene, pack, box);
      flash(builder, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      scene.idle(20);
      scene.overlay()
         .showText(70)
         ...
         .modifyBlockEntityNBT(
            ...
            nbt -> nbt.put(
                  ...
                  NBTHelper.writeCompoundList(
                     ImmutableList.of(IntAttached.with(1, AllItems.ANDESITE_ALLOY.asStack())),
                     ia -> (CompoundTag)((ItemStack)ia.getValue()).saveOptional(builder.world().getHolderLookupProvider())
                  )
               )
         );
      scene.idle(4);
      ...
      scene.idle(20);
      setPanelSatisfied(scene, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      scene.rotateCameraY(-90.0F);
      scene.idle(40);
      scene.overlay()
         .showText(110)
         ...
         .colored(PonderPalette.GREEN)
         .placeNearTarget()
         .pointAt(panelM.add(0.5, 0.0, 0.0));
      scene.idle(120);
      ...
      scene.idle(10);
      setPanelPassive(builder, ironG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      removePanelConnections(builder, ironG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      scene.world().showSection(util.select().position(ironG), Direction.SOUTH);
      scene.idle(15);
      addPanelConnection(builder, nuggG, FactoryPanelBlock.PanelSlot.TOP_LEFT, ironG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      setPanelNotSatisfied(builder, nuggG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      scene.idle(15);
      scene.overlay()
         .showText(110)
         ...
         .pointAt(panelM.add(1.0, -0.5, 0.0));
      scene.idle(120);
      setPanelPassive(builder, dioriteG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      removePanelConnections(builder, dioriteG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      scene.world().showSection(util.select().position(dioriteG), Direction.SOUTH);
      scene.idle(5);
      setPanelPassive(builder, cobbleG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      removePanelConnections(builder, cobbleG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      scene.world().showSection(util.select().position(cobbleG), Direction.SOUTH);
      scene.idle(10);
      addPanelConnection(builder, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, dioriteG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      setPanelNotSatisfied(builder, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      scene.idle(5);
      addPanelConnection(builder, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, cobbleG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      setArrowMode(builder, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT, cobbleG, FactoryPanelBlock.PanelSlot.TOP_LEFT, 2);
      setPanelNotSatisfied(builder, andeG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      scene.idle(15);
      removePanelConnections(builder, quartzG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      removePanelConnections(builder, logsG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      removePanelConnections(builder, alloyG, FactoryPanelBlock.PanelSlot.TOP_RIGHT);
      removePanelConnections(builder, logsG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      removePanelConnections(builder, planksG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      removePanelConnections(builder, rawIronG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      removePanelConnections(builder, cogG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      scene.overlay()
         .showText(110)
         ...
         .colored(PonderPalette.BLUE)
         .placeNearTarget()
         .pointAt(panelM.add(1.0, 0.0, 0.0));
      scene.idle(120);
      setPanelPassive(builder, quartzG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      scene.world().showSection(util.select().position(quartzG), Direction.SOUTH);
      scene.idle(15);
      addPanelConnection(builder, dioriteG, FactoryPanelBlock.PanelSlot.TOP_LEFT, quartzG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      addPanelConnection(builder, dioriteG, FactoryPanelBlock.PanelSlot.TOP_LEFT, cobbleG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      setPanelNotSatisfied(builder, dioriteG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      scene.idle(5);
      ...
      scene.idle(4);
      setPanelVisible(builder, alloyG, FactoryPanelBlock.PanelSlot.TOP_RIGHT, true);
      scene.idle(1);
      addPanelConnection(builder, logsG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT, logsG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      setPanelNotSatisfied(builder, logsG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      ...
      addPanelConnection(builder, alloyG, FactoryPanelBlock.PanelSlot.TOP_RIGHT, alloyG, FactoryPanelBlock.PanelSlot.BOTTOM_LEFT);
      setPanelNotSatisfied(builder, alloyG, FactoryPanelBlock.PanelSlot.TOP_RIGHT);
      scene.idle(5);
      addPanelConnection(builder, ironG, FactoryPanelBlock.PanelSlot.TOP_LEFT, rawIronG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      setPanelNotSatisfied(builder, ironG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
      scene.idle(5);
      addPanelConnection(builder, planksG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT, logsG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      setPanelNotSatisfied(builder, planksG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      scene.idle(5);
      addPanelConnection(builder, cogG, FactoryPanelBlock.PanelSlot.TOP_LEFT, planksG, FactoryPanelBlock.PanelSlot.BOTTOM_RIGHT);
      addPanelConnection(builder, cogG, FactoryPanelBlock.PanelSlot.TOP_LEFT, alloyG, FactoryPanelBlock.PanelSlot.TOP_RIGHT);
      setPanelNotSatisfied(builder, cogG, FactoryPanelBlock.PanelSlot.TOP_LEFT);
   }
   ...
   public static void links(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(7);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, link, boundingBox.move(0.75, -1.25, 0.0).inflate(0.15, 0.25, 0.0), 40);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, gauge, boundingBox, 40);
      addPanelConnection(builder, gauge, slot, link, FactoryPanelBlock.PanelSlot.TOP_RIGHT);
      setArrowMode(builder, gauge, slot, link, FactoryPanelBlock.PanelSlot.TOP_RIGHT, 0);
      scene.idle(20);
      scene.overlay()
         .showText(70)
      ...
      scene.overlay()
         ...
         .colored(PonderPalette.BLUE)
         .placeNearTarget()
         .pointAt(util.vector().of(1.0, 3.0, 1.0));
      scene.idle(100);
   }
   ...
   private static void flash(SceneBuilder builder, BlockPos gauge, FactoryPanelBlock.PanelSlot slot) {
      withGaugeDo(builder, gauge, slot, pb -> pb.bulb.setValue(1.0));
   }
   ...
   private static void setArrowMode(
      SceneBuilder builder, BlockPos gauge, FactoryPanelBlock.PanelSlot slot, BlockPos fromGauge, FactoryPanelBlock.PanelSlot fromSlot, int mode
   ) {
   ...
   private static void addPanelConnection(
      SceneBuilder builder, BlockPos gauge, FactoryPanelBlock.PanelSlot slot, BlockPos fromGauge, FactoryPanelBlock.PanelSlot fromSlot
   ) {
