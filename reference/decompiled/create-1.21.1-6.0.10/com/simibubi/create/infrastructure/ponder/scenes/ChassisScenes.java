...
public class ChassisScenes {
   ...
   public static void linearAttachement(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(10);
      scene.overlay()
         .showControls(util.vector().blockSurface(chassisPos, Direction.WEST), Pointing.LEFT, 30)
         .rightClick()
         .withItem(new ItemStack(Items.SLIME_BALL));
      scene.idle(7);
      scene.world().modifyBlock(chassisPos, s -> (BlockState)s.setValue(LinearChassisBlock.STICKY_BOTTOM, true), false);
      ...
      scene.idle(70);
      scene.overlay()
         .showControls(util.vector().blockSurface(chassisPos, Direction.WEST), Pointing.LEFT, 15)
         .rightClick()
         .withItem(new ItemStack(Items.SLIME_BALL));
      scene.idle(7);
      scene.world().modifyBlock(chassisPos, s -> (BlockState)s.setValue(LinearChassisBlock.STICKY_TOP, true), false);
      ...
      scene.idle(7);
      scene.world().modifyBlock(chassisPos, s -> (BlockState)s.setValue(LinearChassisBlock.STICKY_BOTTOM, false), false);
      scene.effects().superGlue(chassisPos, Direction.WEST, false);
      scene.idle(30);
      scene.overlay()
         .showText(60)
   ...
   public static void radial(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .withItem(new ItemStack(Items.SLIME_BALL));
      scene.idle(7);
      scene.world().modifyBlock(chassisPos, sx -> (BlockState)sx.setValue(RadialChassisBlock.STICKY_WEST, true), false);
      scene.effects().superGlue(chassisPos, Direction.WEST, false);
      scene.idle(30);
      scene.overlay()
         .showText(60)
      ...
      scene.world()
         .modifyBlock(
            chassisPos,
            sx -> (BlockState)((BlockState)((BlockState)sx.setValue(RadialChassisBlock.STICKY_EAST, true)).setValue(RadialChassisBlock.STICKY_NORTH, true))
      ...
      scene.overlay().showControls(util.vector().blockSurface(chassisPos, Direction.WEST), Pointing.LEFT, 30).rightClick().whileSneaking();
      scene.idle(7);
      scene.world().modifyBlock(chassisPos, sx -> (BlockState)sx.setValue(RadialChassisBlock.STICKY_WEST, false), false);
      scene.effects().superGlue(chassisPos, Direction.WEST, false);
      scene.idle(30);
      scene.overlay()
         .showText(60)
      ...
      scene.overlay()
         .showOutlineWithText((Selection)obj.getValue(), 60)
         .colored(PonderPalette.GREEN)
