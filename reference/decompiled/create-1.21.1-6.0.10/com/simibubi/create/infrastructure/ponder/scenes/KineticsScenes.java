...
public class KineticsScenes {
   ...
   public static void shaftsCanBeEncased(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(7);
      scene.world().setBlocks(andesite, (BlockState)andesiteEncased.getDefaultState().setValue(EncasedShaftBlock.AXIS, Axis.X), true);
      ...
      scene.idle(7);
      scene.world().setBlocks(brass, (BlockState)brassEncased.getDefaultState().setValue(EncasedShaftBlock.AXIS, Axis.X), true);
      scene.world().setKineticSpeed(shaft, 32.0F);
      scene.idle(10);
   ...
   public static void largeCogAsRelay(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().setBlock(util.grid().at(4, 2, 3), (BlockState)AllBlocks.LARGE_COGWHEEL.getDefaultState().setValue(CogWheelBlock.AXIS, Axis.X), false);
      scene.showBasePlate();
      scene.idle(5);
      ...
      scene.idle(15);
      scene.world().modifyBlock(util.grid().at(3, 2, 3), s -> (BlockState)s.setValue(ShaftBlock.AXIS, Axis.X), false);
   ...
   public static void cogsSpeedUp(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      BlockState largeCogState = (BlockState)AllBlocks.LARGE_COGWHEEL.getDefaultState().setValue(CogWheelBlock.AXIS, Axis.X);
      BlockState smallCogState = (BlockState)AllBlocks.COGWHEEL.getDefaultState().setValue(CogWheelBlock.AXIS, Axis.X);
   ...
   public static void cogwheelsCanBeEncased(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world()
         .setBlocks(
            ...
            (BlockState)((BlockState)andesiteEncased.getDefaultState().setValue(EncasedCogwheelBlock.AXIS, Axis.Y))
      ...
      scene.idle(7);
      scene.world().setBlocks(small2, (BlockState)andesiteEncased.getDefaultState().setValue(EncasedCogwheelBlock.AXIS, Axis.Y), true);
      ...
      scene.idle(7);
      scene.world().setBlocks(util.select().position(1, 1, 3), (BlockState)brassEncased.getDefaultState().setValue(EncasedCogwheelBlock.AXIS, Axis.Y), true);
      ...
      scene.overlay()
         ...
         .pointAt(wrenchHere.add(-0.5, 0.0, 0.5));
      scene.idle(40);
      scene.overlay().showControls(wrenchHere, Pointing.RIGHT, 25).rightClick().withItem(AllItems.WRENCH.asStack());
      scene.idle(7);
      scene.world().cycleBlockProperty(util.grid().at(2, 1, 2), EncasedCogwheelBlock.TOP_SHAFT);
   ...
   public static void gearbox(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().setBlock(largeCogBack, (BlockState)defaultState.setValue(CogWheelBlock.AXIS, Axis.Z), false);
      scene.world().setBlock(largeCogFront, (BlockState)defaultState.setValue(CogWheelBlock.AXIS, Axis.Z), false);
      scene.world().setBlock(largeCogRight, (BlockState)defaultState.setValue(CogWheelBlock.AXIS, Axis.X), false);
      scene.world().setBlock(largeCogLeft, (BlockState)defaultState.setValue(CogWheelBlock.AXIS, Axis.X), false);
      ...
      scene.idle(90);
      scene.world().setBlock(largeCogFront.north(), (BlockState)cogState.setValue(CogWheelBlock.AXIS, Axis.Z), true);
      scene.world().setBlock(largeCogRight.west(), (BlockState)cogState.setValue(CogWheelBlock.AXIS, Axis.X), true);
      scene.idle(10);
      ...
      scene.world().setBlock(largeCogBack.south(), (BlockState)cogState.setValue(CogWheelBlock.AXIS, Axis.Z), true);
      scene.idle(10);
      scene.effects().rotationDirectionIndicator(largeCogFront.north());
   ...
   public static void valveHandle(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world()
         .modifyBlock(
            valvePos,
            s -> (BlockState)AllBlocks.DYED_VALVE_HANDLES.get(DyeColor.BLUE).getDefaultState().setValue(ValveHandleBlock.FACING, Direction.NORTH),
            true
         );
      scene.idle(10);
   ...
   public static void sequencedGearshift(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().cycleBlockProperty(gearshiftPos, SequencedGearshiftBlock.STATE);
      scene.world().cycleBlockProperty(gearshiftPos, SequencedGearshiftBlock.STATE);
      scene.world().modifyBlock(wire, s -> (BlockState)s.setValue(RedStoneWireBlock.POWER, 0), false);
      scene.world().toggleRedstonePower(util.select().position(5, 1, 1));
   ...
   private static void gauge(SceneBuilder builder, SceneBuildingUtil util, boolean speed) {
      ...
      scene.world()
         .setBlock(
            gaugePos, (BlockState)(speed ? AllBlocks.SPEEDOMETER : AllBlocks.STRESSOMETER).getDefaultState().setValue(GaugeBlock.FACING, Direction.UP), true
         );
      ...
      if (speed) {
         ...
         BlockState state = (BlockState)AllBlocks.CRUSHING_WHEEL.getDefaultState().setValue(CrushingWheelBlock.AXIS, Axis.X);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .colored(PonderPalette.RED)
         .pointAt(util.vector().centerOf(2, 1, 2).add(0.0, -0.35, 0.0))
         .placeNearTarget();
      scene.idle(130);
      scene.markAsFinished();
   }
