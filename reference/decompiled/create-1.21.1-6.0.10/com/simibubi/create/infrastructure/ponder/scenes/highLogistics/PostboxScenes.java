...
public class PostboxScenes {
   public static void postbox(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .colored(PonderPalette.BLUE)
         .text("Warehouse")
         .pointAt(util.vector().blockSurface(box, Direction.NORTH).add(-0.5, 0.0, 0.0))
         .placeNearTarget();
      scene.idle(5);
      ...
      scene.overlay()
         ...
         .text("→ Warehouse")
         .pointAt(util.vector().centerOf(3, 2, 2).add(0.0, -0.25, 0.0))
         .placeNearTarget();
      scene.idle(50);
      ...
      scene.idle(5);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.BLUE, train1L, new AABB(util.grid().at(1, 3, 4)).inflate(1.0, 0.75, 0.5), 280);
      scene.overlay().chaseBoundingBoxOutline(PonderPalette.BLUE, train2L, new AABB(util.grid().at(5, 3, 4)).inflate(1.0, 0.75, 0.5), 280);
      scene.idle(19);
