...
public class SteamScenes {
   ...
   public static void engine(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().modifyBlock(util.grid().at(4, 2, 7), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.SOUTH), false);
      scene.world().modifyBlock(util.grid().at(1, 2, 7), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.SOUTH), false);
      scene.world().modifyBlock(util.grid().at(2, 3, 7), s -> (BlockState)s.setValue(PumpBlock.FACING, Direction.SOUTH), false);
      scene.idle(15);
      ElementLink<WorldSectionElement> tankElement = scene.world().showIndependentSection(tank, Direction.DOWN);
      ...
      scene.overlay()
         ...
         .rightClick();
      scene.idle(10);
      scene.world().setBlock(engine1ShaftPos, (BlockState)AllBlocks.SHAFT.getDefaultState().setValue(ShaftBlock.AXIS, Axis.Z), false);
      ...
      scene.world().setBlock(engine1ShaftPos, (BlockState)AllBlocks.POWERED_SHAFT.getDefaultState().setValue(ShaftBlock.AXIS, Axis.Z), false);
      ...
      scene.world()
         .setBlocks(
            burners, (BlockState)AllBlocks.BLAZE_BURNER.getDefaultState().setValue(BlazeBurnerBlock.HEAT_LEVEL, BlazeBurnerBlock.HeatLevel.KINDLED), false
         );
      scene.idle(5);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .colored(PonderPalette.BLUE)
         .pointAt(target.add(0.0, 0.0, 0.5))
         .placeNearTarget();
      scene.idle(90);
      ...
      scene.world()
         .setBlocks(
            burners, (BlockState)AllBlocks.BLAZE_BURNER.getDefaultState().setValue(BlazeBurnerBlock.HEAT_LEVEL, BlazeBurnerBlock.HeatLevel.SEETHING), false
         );
      scene.idle(15);
