...
public class EjectorScenes {
   public static void ejector(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .pointAt(input.add(0.0, 0.0, 0.125))
         .placeNearTarget();
      ...
      scene.world().modifyEntities(ItemEntity.class, Entity::discard);
      scene.addKeyframe();
      ElementLink<ParrotElement> birb = scene.special().createBirb(util.vector().topOf(ejectorPos).add(0.0, -0.1875, 0.0), FlappyPose::new);
      scene.idle(15);
      ...
      scene.idle(15);
      scene.special().changeBirbPose(birb, FaceCursorPose::new);
      scene.overlay()
         .showText(80)
