...
public class TableClothScenes {
   public static void tableCloth(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .pointAt(util.vector().of(3.0, 1.75, 3.0))
         .placeNearTarget();
      scene.idle(110);
      ...
      scene.overlay()
         ...
         .pointAt(util.vector().of(2.0, 3.0, 4.0))
         .placeNearTarget();
      scene.idle(110);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .pointAt(util.vector().of(4.0, 3.0, 4.0))
         .placeNearTarget();
      scene.idle(80);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .pointAt(util.vector().of(5.0, 2.0, 1.5))
         .placeNearTarget();
      scene.idle(100);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .pointAt(util.vector().of(2.5, 2.5, 4.0))
         .placeNearTarget();
      scene.idle(100);
      ...
      scene.overlay()
         ...
         .attachKeyFrame()
         .pointAt(util.vector().of(1.0, 2.5, 1.5))
         .placeNearTarget();
      scene.idle(100);
