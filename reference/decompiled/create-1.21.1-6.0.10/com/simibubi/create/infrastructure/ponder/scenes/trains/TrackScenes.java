...
public class TrackScenes {
   ...
   public static void portal(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      ElementLink<ParrotElement> birb = scene.special().createBirb(util.vector().centerOf(4, 3, 2), FacePointOfInterestPose::new);
   ...
   public static void chunks(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      ElementLink<ParrotElement> birb = scene.special().createBirb(util.vector().centerOf(2, 2, 7), FacePointOfInterestPose::new);
