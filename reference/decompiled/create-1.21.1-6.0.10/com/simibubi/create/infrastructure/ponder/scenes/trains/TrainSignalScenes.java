...
public class TrainSignalScenes {
   public static void placement(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         .showText(80)
         .pointAt(marker.add(-0.45, 0.0, 0.0))
         .attachKeyFrame()
         .placeNearTarget()
   ...
   public static void signaling(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      ElementLink<ParrotElement> birb1 = scene.special().createBirb(util.vector().centerOf(18, 3, 7), FacePointOfInterestPose::new);
      ...
      ElementLink<ParrotElement> birb2 = scene.special().createBirb(util.vector().centerOf(18, 3, 7), FacePointOfInterestPose::new);
      ...
      birb1 = scene.special().createBirb(util.vector().centerOf(3, 3, 7).add(0.5, 0.0, 0.0), DancePose::new);
      scene.idle(10);
      ...
      for (int i = 1; i < 14; i++) {
         scene.idle(2);
         scene.overlay()
            .chaseBoundingBoxOutline(i == 13 ? PonderPalette.RED : PonderPalette.OUTPUT, trainBB, trainBB.move((double)(-i) * 0.5, 0.0, 0.0), i == 13 ? 100 : 5);
      }
      ...
      scene.overlay()
         .showText(80)
         .pointAt(util.vector().of(7.0, 4.0, 7.0))
         .placeNearTarget()
         .colored(PonderPalette.RED)
      ...
      ElementLink<ParrotElement> birb3 = scene.special().createBirb(util.vector().of(18.0, 3.5, -2.0), FacePointOfInterestPose::new);
