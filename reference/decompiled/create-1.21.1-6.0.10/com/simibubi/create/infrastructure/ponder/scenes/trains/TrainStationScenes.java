...
public class TrainStationScenes {
   public static void assembly(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         .showOutline(
            PonderPalette.GREEN, casing, util.select().position(10, 2, 6).add(util.select().position(6, 2, 6)).add(util.select().position(3, 2, 6)), 40
         );
      scene.overlay()
         .showText(70)
      ...
      scene.idle(20);
      ElementLink<ParrotElement> birb = scene.special().createBirb(util.vector().centerOf(10, 3, 6), FacePointOfInterestPose::new);
      scene.idle(15);
   ...
   public static void autoSchedule(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         .showText(80)
         .pointAt(util.vector().topOf(stationPos.north()).subtract(0.0, 0.875, 0.0))
         .placeNearTarget()
         .attachKeyFrame()
      ...
      scene.overlay()
         .showText(70)
         .pointAt(util.vector().topOf(stationPos).add(-0.5, 0.0, 0.0))
         .placeNearTarget()
         .attachKeyFrame()
