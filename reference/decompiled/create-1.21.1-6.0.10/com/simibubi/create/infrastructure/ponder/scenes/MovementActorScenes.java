...
public class MovementActorScenes {
   ...
   public static void harvester(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.world().setBlocks(crops, (BlockState)Blocks.WHEAT.defaultBlockState().setValue(CropBlock.AGE, 7), false);
      scene.world().showSection(util.select().layer(0), Direction.UP);
   ...
   public static void plough(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.idle(10);
      ElementLink<ParrotElement> birb = scene.special().createBirb(util.vector().topOf(3, 0, 2).add(0.0, 0.0, 0.5), FlappyPose::new);
      scene.idle(11);
      scene.world().modifyKineticSpeed(util.select().everywhere(), f -> -2.0F * f);
   ...
   public static void contraptionControls(SceneBuilder builder, SceneBuildingUtil util) {
      ...
      scene.overlay()
         .showText(60)
         .placeNearTarget()
         .pointAt(util.vector().topOf(controlsPos1).add(0.0, -0.25, 0.0))
         .attachKeyFrame()
      ...
      scene.overlay()
         .showText(60)
         .placeNearTarget()
         .pointAt(util.vector().topOf(controlsPos2).add(0.0, -0.25, 0.0))
         .attachKeyFrame()
