...
public class CEquipment extends ConfigBase {
   public final ConfigInt maxSymmetryWandRange = this.i(50, 10, "maxSymmetryWandRange", new String[]{CEquipment.Comments.symmetryRange});
   public final ConfigInt placementAssistRange = this.i(12, 3, "placementAssistRange", new String[]{CEquipment.Comments.placementRange});
   public final ConfigInt toolboxRange = this.i(10, 1, "toolboxRange", new String[]{CEquipment.Comments.toolboxRange});
   public final ConfigInt airInBacktank = this.i(900, 1, "airInBacktank", new String[]{CEquipment.Comments.maxAirInBacktank});
   public final ConfigInt enchantedBacktankCapacity = this.i(300, 1, "enchantedBacktankCapacity", new String[]{CEquipment.Comments.enchantedBacktankCapacity});
   public final ConfigInt maxExtendoGripActions = this.i(1000, 0, "maxExtendoGripActions", new String[]{CEquipment.Comments.maxExtendoGripActions});
   public final ConfigInt maxPotatoCannonShots = this.i(200, 0, "maxPotatoCannonShots", new String[]{CEquipment.Comments.maxPotatoCannonShots});
