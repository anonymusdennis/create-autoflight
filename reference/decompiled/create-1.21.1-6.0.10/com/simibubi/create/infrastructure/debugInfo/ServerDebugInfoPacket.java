...
public record ServerDebugInfoPacket(String serverInfo) implements ClientboundPacketPayload {
   public static final StreamCodec<ByteBuf, ServerDebugInfoPacket> STREAM_CODEC = ByteBufCodecs.STRING_UTF8
      .map(ServerDebugInfoPacket::new, ServerDebugInfoPacket::serverInfo);
   ...
   public void handle(LocalPlayer player) {
      ...
      CreateLang.translate("command.debuginfo.saved_to_clipboard").color((Integer)DyeHelper.getDyeColors(DyeColor.LIME).getFirst()).sendChat(player);
   }
