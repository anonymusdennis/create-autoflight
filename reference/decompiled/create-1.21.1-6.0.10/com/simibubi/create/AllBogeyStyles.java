...
public class AllBogeyStyles {
   ...
   public static final BogeyStyle STANDARD = builder("standard", STANDARD_CYCLE_GROUP)
      ...
      .size(BogeySizes.SMALL, AllBlocks.SMALL_BOGEY, () -> () -> new BogeyStyle.SizeRenderer(new StandardBogeyRenderer.Small(), StandardBogeyVisual.Small::new))
      .size(BogeySizes.LARGE, AllBlocks.LARGE_BOGEY, () -> () -> new BogeyStyle.SizeRenderer(new StandardBogeyRenderer.Large(), StandardBogeyVisual.Large::new))
      .build();
