...
public class CompositeWidget extends AbstractContainerEventHandler implements NarratableEntry, Renderable, TickableGuiEventListener {
   ...
   public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
      this.getChildAt((double)mouseX, (double)mouseY).ifPresent(hovered -> this.hovered = hovered);
   ...
   public NarrationPriority narrationPriority() {
      if (this.getFocused() instanceof NarratableEntry) {
         ...
         return this.hovered instanceof NarratableEntry ? NarrationPriority.HOVERED : NarrationPriority.NONE;
      }
   }
