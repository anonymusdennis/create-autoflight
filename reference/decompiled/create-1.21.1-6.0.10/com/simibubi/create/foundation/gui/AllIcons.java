...
public class AllIcons implements ScreenElement {
   ...
   public static final AllIcons I_SEND_ONLY = newRow();
   public static final AllIcons I_SEND_AND_RECEIVE = next();
   public static final AllIcons I_PARTIAL_REQUESTS = next();
   public static final AllIcons I_FULL_REQUESTS = next();
   public static final AllIcons I_MOVE_GAUGE = next();
