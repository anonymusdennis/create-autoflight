...
public class RemovedGuiUtils {
   ...
   public static void drawHoveringText(
      GuiGraphics graphics, List<? extends FormattedText> textLines, int mouseX, int mouseY, int screenWidth, int screenHeight, int maxTextWidth, Font font
   ) {
   ...
   public static void drawHoveringText(
      ...
      if (!textLines.isEmpty()) {
         ...
         Pre event = new Pre(stack, graphics, mouseX, mouseY, screenWidth, screenHeight, font, list, null);
         if (!((Pre)NeoForge.EVENT_BUS.post(event)).isCanceled()) {
            ...
            int zLevel = 400;
            Color colorEvent = new Color(stack, graphics, tooltipX, tooltipY, font, backgroundColor, borderColorStart, borderColorEnd, list);
            ...
            graphics.fillGradient(
               tooltipX - 3, tooltipY + tooltipHeight + 3, tooltipX + tooltipTextWidth + 3, tooltipY + tooltipHeight + 4, 400, backgroundColor, backgroundColor
            );
            graphics.fillGradient(
               tooltipX - 3, tooltipY - 3, tooltipX + tooltipTextWidth + 3, tooltipY + tooltipHeight + 3, 400, backgroundColor, backgroundColor
            );
            ...
            graphics.fillGradient(
               tooltipX - 3, tooltipY + tooltipHeight + 2, tooltipX + tooltipTextWidth + 3, tooltipY + tooltipHeight + 3, 400, borderColorEnd, borderColorEnd
            );
            BufferSource renderType = graphics.bufferSource();
