...
public class RenderTypes extends RenderStateShard {
   public static final ShaderStateShard GLOWING_SHADER = new ShaderStateShard(() -> RenderTypes.Shaders.glowingShader);
   ...
   private static final Function<ResourceLocation, RenderType> CHAIN = Util.memoize(
      p_234330_ -> RenderType.create(
   ...
   private static RenderType getTrainMap(ResourceLocation locationIn, boolean linearFiltering) {
      CompositeState rendertype$state = CompositeState.builder()
         ...
         .setTextureState(new TextureStateShard(locationIn, linearFiltering, false))
         .setTransparencyState(NO_TRANSPARENCY)
         .setLightmapState(LIGHTMAP)
         .createCompositeState(false);
      return RenderType.create("create_train_map", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, Mode.QUADS, 256, false, true, rendertype$state);
   }
   ...
   private static class Shaders {
      ...
      public static void onRegisterShaders(RegisterShadersEvent event) throws IOException {
         ...
         event.registerShader(
            new ShaderInstance(resourceProvider, Create.asResource("glowing_shader"), DefaultVertexFormat.NEW_ENTITY), shader -> glowingShader = shader
         );
      }
   }
}
