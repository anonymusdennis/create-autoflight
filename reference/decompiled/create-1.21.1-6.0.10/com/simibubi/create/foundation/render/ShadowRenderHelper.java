...
public class ShadowRenderHelper {
   private static final RenderType SHADOW_LAYER = RenderType.entityNoOutline(ResourceLocation.withDefaultNamespace("textures/misc/shadow.png"));
   ...
   private static void renderBlockShadow(
      Pose entry, VertexConsumer builder, LevelReader world, BlockPos pos, double x, double y, double z, float radius, float opacity
   ) {
   ...
   private static void shadowVertex(Pose entry, VertexConsumer builder, float alpha, float x, float y, float z, float u, float v) {
