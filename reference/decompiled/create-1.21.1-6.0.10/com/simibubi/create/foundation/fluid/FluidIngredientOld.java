...
public class FluidIngredientOld {
   private static final Codec<SizedFluidIngredient> FLUID_STACK = RecordCodecBuilder.create(
      i -> i.group(
            ...
            .apply(
               ...
               (type, fluid, components, amount) -> new SizedFluidIngredient(
                     DataComponentFluidIngredient.of(false, components.split().added(), new Holder[]{fluid}), amount
                  )
            )
   );
   private static final Codec<SizedFluidIngredient> FLUID_TAG = RecordCodecBuilder.create(
      i -> i.group(
