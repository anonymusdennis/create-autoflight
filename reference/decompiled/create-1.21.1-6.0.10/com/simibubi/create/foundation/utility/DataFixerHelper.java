...
public class DataFixerHelper {
   private static final Set<DataFixerHelper.BlockPosFixer> BLOCK_POS_FIXERS = new HashSet<>();
   public static final Set<DataFixerHelper.BlockPosFixer> BLOCK_POS_FIXERS_VIEW = Collections.unmodifiableSet(BLOCK_POS_FIXERS);

   private static void addBlockPosFixer(TypeReference reference, Set<String> ids, Set<String> fields) {
      for (String id : ids) {
         addBlockPosFixer(reference, id, fields);
      }
   }

   private static void addBlockPosFixer(TypeReference reference, String id, Set<String> fields) {
   ...
   private static void addBlockPosFixer(TypeReference reference, Set<String> ids, Function<Dynamic<?>, Dynamic<?>> customFixer) {
      for (String id : ids) {
         addBlockPosFixer(reference, id, customFixer);
      }
   }

   private static void addBlockPosFixer(TypeReference reference, String id, Function<Dynamic<?>, Dynamic<?>> customFixer) {
      BLOCK_POS_FIXERS.add(new DataFixerHelper.BlockPosFixer(reference, id.contains(":") ? id : "create:" + id, null, customFixer));
   }

   private static void addBlockPosFixer(TypeReference reference, String id, Map<String, String> renames) {
      BLOCK_POS_FIXERS.add(new DataFixerHelper.BlockPosFixer(reference, id.contains(":") ? id : "create:" + id, renames, null));
   }
   ...
   static {
      ...
      addBlockPosFixer(References.BLOCK_ENTITY, Set.of("rope_pulley", "elevator_pulley"), data -> convertListOfBlockPositions("MirrorChildren", data));
      addBlockPosFixer(References.BLOCK_ENTITY, "powered_shaft", Set.of("EnginePos"));
   }

   public static record BlockPosFixer(TypeReference reference, String id, Map<String, String> renames, Function<Dynamic<?>, Dynamic<?>> customFixer) {
   }
}
