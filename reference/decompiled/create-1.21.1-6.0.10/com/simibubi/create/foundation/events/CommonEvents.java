   ...
   public static class ModBusEvents {
      ...
      public static void addPackFinders(AddPackFindersEvent event) {
         if (event.getPackType() == PackType.SERVER_DATA) {
            ...
            event.addRepositorySource(new DynamicPackSource("create:dynamic_data", PackType.SERVER_DATA, Position.BOTTOM, dynamicPack));
         }
      }

      @SubscribeEvent
      public static void onRegisterMapDecorationRenderers(RegisterMapDecorationRenderersEvent event) {
         event.register((MapDecorationType)AllMapDecorationTypes.STATION_MAP_DECORATION.value(), new StationMapDecorationRenderer());
      }
