...
public class MechanicalCraftingRecipeBuilder {
   ...
   public MechanicalCraftingRecipeBuilder key(Character c, ItemLike item) {
      return this.key(c, Ingredient.of(new ItemLike[]{item}));
   }
   ...
   public void build(RecipeOutput output, ResourceLocation id) {
      ...
      MechanicalCraftingRecipe recipe = new MechanicalCraftingRecipe(
         "", CraftingBookCategory.MISC, ShapedRecipePattern.of(this.key, this.pattern), new ItemStack(this.result, this.count), this.acceptMirrored
      );
      output.accept(id, recipe, null, this.recipeConditions.toArray(ICondition[]::new));
   }
