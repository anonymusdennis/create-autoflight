...
public class AllSpriteShifts {
   ...
   public static final CTSpriteShiftEntry HORIZONTAL_FRAMED_GLASS = getCT(
      AllCTTypes.HORIZONTAL_KRYPPERS, "palettes/framed_glass", "palettes/horizontal_framed_glass"
   );
   ...
   public static final CTSpriteShiftEntry INDUSTRIAL_IRON_WINDOW = getCT(AllCTTypes.RECTANGLE, "palettes/industrial_iron_window");
   public static final CTSpriteShiftEntry OLD_FACTORY_WINDOW_1 = getCT(
      AllCTTypes.RECTANGLE, "palettes/weathered_iron_window", "palettes/weathered_iron_window_1"
   );
   public static final CTSpriteShiftEntry OLD_FACTORY_WINDOW_2 = getCT(
      AllCTTypes.RECTANGLE, "palettes/weathered_iron_window", "palettes/weathered_iron_window_2"
   );
   public static final CTSpriteShiftEntry OLD_FACTORY_WINDOW_3 = getCT(
      AllCTTypes.RECTANGLE, "palettes/weathered_iron_window", "palettes/weathered_iron_window_3"
   );
   public static final CTSpriteShiftEntry OLD_FACTORY_WINDOW_4 = getCT(
      AllCTTypes.RECTANGLE, "palettes/weathered_iron_window", "palettes/weathered_iron_window_4"
   );
   ...
   public static final SpriteShiftEntry HOSE_PULLEY_COIL = get("block/hose_pulley_coil", "block/hose_pulley_coil_scroll");
   public static final SpriteShiftEntry FACTORY_PANEL_CONNECTIONS = get("block/factory_panel_connections", "block/factory_panel_connections_animated");
   ...
   private static Couple<CTSpriteShiftEntry> vault(String name) {
      ...
      return Couple.createWithContext(
         medium -> CTSpriteShifter.getCT(
               AllCTTypes.RECTANGLE, Create.asResource(prefixed + "_small"), Create.asResource(medium ? prefixed + "_medium" : prefixed + "_large")
            )
      );
   }
