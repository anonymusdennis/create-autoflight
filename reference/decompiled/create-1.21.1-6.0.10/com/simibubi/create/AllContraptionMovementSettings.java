...
public class AllContraptionMovementSettings {
   public static void registerDefaults() {
      ContraptionMovementSetting.REGISTRY.register(Blocks.SPAWNER, () -> (ContraptionMovementSetting)AllConfigs.server().kinetics.spawnerMovement.get());
      ContraptionMovementSetting.REGISTRY
         .register(Blocks.BUDDING_AMETHYST, () -> (ContraptionMovementSetting)AllConfigs.server().kinetics.amethystMovement.get());
      ContraptionMovementSetting.REGISTRY.register(Blocks.OBSIDIAN, () -> (ContraptionMovementSetting)AllConfigs.server().kinetics.obsidianMovement.get());
      ContraptionMovementSetting.REGISTRY
