...
public class AllPartialModels {
   ...
   public static final PartialModel SHAFT = block("shaft");
   public static final PartialModel COGWHEEL = block("cogwheel");
   ...
   public static final PartialModel HAND_CRANK_BASE = block("hand_crank/block");
   ...
   public static final PartialModel ROPE = block("rope_pulley/rope");
   public static final PartialModel PULLEY_MAGNET = block("rope_pulley/pulley_magnet");
   public static final PartialModel HOSE_COIL = block("hose_pulley/hose_coil");
   ...
   public static final PartialModel DESK_BELL_PLUNGER = block("desk_bell/plunger");
   public static final PartialModel DESK_BELL_BELL = block("desk_bell/bell");
   ...
   public static final PartialModel CHAIN_CONVEYOR_WHEEL = block("chain_conveyor/wheel");
   public static final PartialModel CHAIN_CONVEYOR_GUARD = block("chain_conveyor/guard");
   public static final PartialModel CHAIN_CONVEYOR_SHAFT = block("chain_conveyor/shaft");
   public static final PartialModel FROGPORT_BODY = block("package_frogport/body");
   public static final PartialModel FROGPORT_HEAD = block("package_frogport/head");
   public static final PartialModel FROGPORT_HEAD_GOGGLES = block("package_frogport/head_goggles");
   public static final PartialModel FROGPORT_TONGUE = block("package_frogport/tongue");
   public static final PartialModel POSTBOX_FLAG = block("package_postbox/flag");
   public static final PartialModel PACKAGER_TRAY_REGULAR = block("packager/tray");
   public static final PartialModel PACKAGER_TRAY_DEFRAG = block("repackager/tray");
   public static final PartialModel PACKAGER_HATCH_OPEN = block("packager/hatch_open");
   public static final PartialModel PACKAGER_HATCH_CLOSED = block("packager/hatch_closed");
   public static final PartialModel TABLE_CLOTH_PRICE_SIDE = block("table_cloth/price_tag_side");
   public static final PartialModel TABLE_CLOTH_PRICE_TOP = block("table_cloth/price_tag_top");
   ...
   public static final PartialModel BOGEY_DRIVE_BELT = block("track/bogey/bogey_drive_belt");
   ...
   public static final PartialModel SIGNAL_COMPUTER_WHITE_CUBE = block("track_signal/computer_white_cube");
   public static final PartialModel SIGNAL_COMPUTER_WHITE_GLOW = block("track_signal/computer_white_glow");
   public static final PartialModel SIGNAL_COMPUTER_WHITE = block("track_signal/computer_white_tube");
   public static final PartialModel SIGNAL_COMPUTER_WHITE_BASE = block("track_signal/computer_white_tube_base");
   public static final PartialModel BLAZE_CAGE = block("blaze_burner/block");
   ...
   public static final PartialModel FACTORY_PANEL = block("factory_gauge/panel");
   public static final PartialModel FACTORY_PANEL_WITH_BULB = block("factory_gauge/panel_with_bulb");
   public static final PartialModel FACTORY_PANEL_RESTOCKER = block("factory_gauge/panel_restocker");
   public static final PartialModel FACTORY_PANEL_RESTOCKER_WITH_BULB = block("factory_gauge/panel_restocker_with_bulb");
   public static final PartialModel FACTORY_PANEL_LIGHT = block("factory_gauge/bulb_light");
   public static final PartialModel FACTORY_PANEL_RED_LIGHT = block("factory_gauge/bulb_red");
   public static final PartialModel TABLE_CLOTH_NW = block("table_cloth/north_west");
   public static final PartialModel TABLE_CLOTH_NE = block("table_cloth/north_east");
   public static final PartialModel TABLE_CLOTH_SW = block("table_cloth/south_west");
   public static final PartialModel TABLE_CLOTH_SE = block("table_cloth/south_east");
   public static final PartialModel FLYWHEEL = block("flywheel/block");
   public static final PartialModel CRUSHING_WHEEL = block("crushing_wheel/block");
   public static final PartialModel TURNTABLE = block("turntable");
   ...
   public static final PartialModel POWERED_SHAFT = block("powered_shaft");
   ...
   public static final PartialModel LOGISTICS_HAT = entity("logistics_hat");
   ...
   public static final Map<AllPartialModels.GantryShaftKey, PartialModel> GANTRY_SHAFTS = new HashMap<>();
      ...
      for (boolean flipped : Iterate.trueAndFalse) {
         for (boolean powered : Iterate.trueAndFalse) {
            for (GantryShaftBlock.Part part : GantryShaftBlock.Part.values()) {
               AllPartialModels.GantryShaftKey key = new AllPartialModels.GantryShaftKey(part, powered, flipped);
   ...
   public static record GantryShaftKey(GantryShaftBlock.Part part, boolean powered, boolean flipped) {
