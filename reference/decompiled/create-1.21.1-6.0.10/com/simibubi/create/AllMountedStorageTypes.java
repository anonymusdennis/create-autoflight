...
public class AllMountedStorageTypes {
   ...
   public static final RegistryEntry<MountedItemStorageType<?>, CreativeCrateMountedStorageType> CREATIVE_CRATE = simpleItem(
      "creative_crate", CreativeCrateMountedStorageType::new
   );
   ...
   public static final RegistryEntry<MountedFluidStorageType<?>, FluidTankMountedStorageType> FLUID_TANK = simpleFluid(
      "fluid_tank", FluidTankMountedStorageType::new
   );
   public static final RegistryEntry<MountedFluidStorageType<?>, CreativeFluidTankMountedStorageType> CREATIVE_FLUID_TANK = simpleFluid(
      "creative_fluid_tank", CreativeFluidTankMountedStorageType::new
   );
   public static final RegistryEntry<MountedItemStorageType<?>, SimpleMountedStorageType.Impl> SIMPLE = REGISTRATE.mountedItemStorage(
         "simple", SimpleMountedStorageType.Impl::new
      )
      .associateBlockTag(AllTags.AllBlockTags.SIMPLE_MOUNTED_STORAGE.tag)
      .register();
   public static final RegistryEntry<MountedItemStorageType<?>, ChestMountedStorageType> CHEST = REGISTRATE.mountedItemStorage(
         "chest", ChestMountedStorageType::new
      )
      .associateBlockTag(AllTags.AllBlockTags.CHEST_MOUNTED_STORAGE.tag)
      .register();
   public static final RegistryEntry<MountedItemStorageType<?>, DispenserMountedStorageType> DISPENSER = REGISTRATE.mountedItemStorage(
         "dispenser", DispenserMountedStorageType::new
      )
