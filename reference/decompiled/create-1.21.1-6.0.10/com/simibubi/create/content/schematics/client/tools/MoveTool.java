...
public class MoveTool extends PlacementToolBase {
   ...
   public boolean handleMouseWheel(double delta) {
      if (this.schematicSelected && this.selectedFace.getAxis().isHorizontal()) {
         ...
         vec = vec.multiply((double)transformation.getMirrorModifier(Axis.X), 1.0, (double)transformation.getMirrorModifier(Axis.Z));
         vec = VecHelper.rotate(vec, (double)transformation.getRotationTarget(), Axis.Y);
