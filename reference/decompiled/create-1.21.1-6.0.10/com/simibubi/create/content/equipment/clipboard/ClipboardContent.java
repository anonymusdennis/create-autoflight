...
public record ClipboardContent(
   ClipboardOverrides.ClipboardType type, List<List<ClipboardEntry>> pages, boolean readOnly, int previouslyOpenedPage, Optional<CompoundTag> copiedValues
) {
   ...
   public static final StreamCodec<RegistryFriendlyByteBuf, List<List<ClipboardEntry>>> PAGES_STREAM_CODEC = CatnipStreamCodecBuilders.list(
      CatnipStreamCodecBuilders.list(ClipboardEntry.STREAM_CODEC)
   );
   public static final Codec<ClipboardContent> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               ClipboardOverrides.ClipboardType.CODEC.fieldOf("type").forGetter(ClipboardContent::type),
   ...
   public static final StreamCodec<RegistryFriendlyByteBuf, ClipboardContent> STREAM_CODEC = StreamCodec.composite(
      ClipboardOverrides.ClipboardType.STREAM_CODEC,
