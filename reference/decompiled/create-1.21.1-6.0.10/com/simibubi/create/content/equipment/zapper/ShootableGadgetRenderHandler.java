...
public abstract class ShootableGadgetRenderHandler {
   ...
   public float getAnimation(boolean rightHand, float partialTicks) {
      return Mth.lerp(
         partialTicks, rightHand ? this.lastRightHandAnimation : this.lastLeftHandAnimation, rightHand ? this.rightHandAnimation : this.leftHandAnimation
      );
   }
   ...
   protected void onRenderPlayerHand(RenderHandEvent event) {
      ...
      if (this.appliesTo(heldItem)) {
         ...
         float recoil = rightHand
            ? Mth.lerp(pt, this.lastRightHandAnimation, this.rightHandAnimation)
            : Mth.lerp(pt, this.lastLeftHandAnimation, this.leftHandAnimation);
