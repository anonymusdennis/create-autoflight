...
public record KnockbackPacket(float yRot, float strength) implements ClientboundPacketPayload {
   public static final StreamCodec<ByteBuf, KnockbackPacket> STREAM_CODEC = StreamCodec.composite(
      ByteBufCodecs.FLOAT, KnockbackPacket::yRot, ByteBufCodecs.FLOAT, KnockbackPacket::strength, KnockbackPacket::new
   );
   ...
   public void handle(LocalPlayer player) {
      if (player != null) {
         CardboardSwordItem.knockback(player, (double)this.strength, this.yRot);
      }
   }
}
