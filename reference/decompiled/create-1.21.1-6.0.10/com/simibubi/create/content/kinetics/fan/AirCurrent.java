      ...
      while (iterator.hasNext()) {
         ...
         if (entity.isAlive() && entity.getBoundingBox().intersects(this.bounds) && !isPlayerCreativeFlying(entity)) {
            ...
            if (CatnipServices.PLATFORM.getEnv().isClient()) {
               AirCurrent.Client.enableClientPlayerSound(entity, Mth.clamp(speed / 128.0F * 0.4F, 0.01F, 0.4F));
            }
            ...
            if (processingType != null) {
               if (entity instanceof ItemEntity) {
                  ...
                  } else if (FanProcessing.canProcess(itemEntity, processingType)
                     && FanProcessing.applyProcessing(itemEntity, processingType)
                     && this.source instanceof EncasedFanBlockEntity fan) {
