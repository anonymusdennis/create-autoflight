...
public class Instruction {
   ...
   static Instruction deserialize(CompoundTag tag) {
      Instruction instruction = new Instruction((SequencerInstructions)NBTHelper.readEnum(tag, "Type", SequencerInstructions.class));
      instruction.speedModifier = (InstructionSpeedModifiers)NBTHelper.readEnum(tag, "Modifier", InstructionSpeedModifiers.class);
