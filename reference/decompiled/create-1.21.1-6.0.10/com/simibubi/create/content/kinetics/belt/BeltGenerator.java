...
public class BeltGenerator extends SpecialBlockStateGen {
   ...
   protected int getXRotation(BlockState state) {
      ...
      return slope == BeltSlope.VERTICAL ? 90 : (slope == BeltSlope.SIDEWAYS && direction.getAxisDirection() == AxisDirection.NEGATIVE ? 180 : 0);
   }

   @Override
   protected int getYRotation(BlockState state) {
      Boolean casing = (Boolean)state.getValue(BeltBlock.CASING);
      BeltSlope slope = (BeltSlope)state.getValue(BeltBlock.SLOPE);
