...
public interface IAirCurrentSource {
   ...
   default float getMaxDistance() {
      ...
      float pushDistance = Mth.lerp(distanceFactor, 3.0F, (float)((Integer)config.fanPushDistance.get()).intValue());
      float pullDistance = Mth.lerp(distanceFactor, 3.0F, (float)((Integer)config.fanPullDistance.get()).intValue());
