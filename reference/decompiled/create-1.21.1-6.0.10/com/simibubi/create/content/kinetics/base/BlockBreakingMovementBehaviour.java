...
public class BlockBreakingMovementBehaviour implements MovementBehaviour {
      ...
      if (damageSource != null || this.throwsEntities(world)) {
         ...
         for (Entity entity : world.getEntitiesOfClass(Entity.class, new AABB(pos))) {
            if (!(entity instanceof ItemEntity)
               ...
               && !entity.isPassengerOfSameVehicle(context.contraption.entity)) {
         ...
         if (!data.contains("BreakingPos")) {
            ...
            if (ticksUntilNextProgress-- > 0) {
               ...
               if (!this.canBreak(world, breakingPos, stateToBreak)) {
                  ...
                  world.playSound(null, breakingPos, stateToBreak.getSoundType(world, breakingPos, null).getHitSound(), SoundSource.NEUTRAL, 0.25F, 1.0F);
                  if (destroyProgress < 10) {
                     ...
                     for (BlockState stateAbove = world.getBlockState(breakingPos.above());
                        stateAbove.getBlock() instanceof FallingBlock;
   ...
   protected void destroyBlock(MovementContext context, BlockPos breakingPos) {
      BlockHelper.destroyBlock(context.world, breakingPos, 1.0F, stack -> this.collectOrDropItem(context, stack));
   }
