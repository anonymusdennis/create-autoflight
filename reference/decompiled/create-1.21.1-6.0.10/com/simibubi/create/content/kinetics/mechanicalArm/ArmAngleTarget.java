...
public class ArmAngleTarget {
   ...
   public ArmAngleTarget(BlockPos armPos, Vec3 pointTarget, Direction clawFacing, boolean ceiling) {
      ...
      headPos = VecHelper.rotate(headPos.add(0.0, (double)b, 0.0), (double)(beta + 180.0F), Axis.X);
      headPos = VecHelper.rotate(headPos.add(0.0, (double)a, 0.0), (double)(alpha - 90.0F), Axis.X);
      headPos = VecHelper.rotate(headPos, (double)baseAngle, Axis.Y);
