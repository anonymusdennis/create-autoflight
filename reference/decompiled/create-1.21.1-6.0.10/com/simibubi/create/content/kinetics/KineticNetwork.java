...
public class KineticNetwork {
   ...
   public float getActualCapacityOf(KineticBlockEntity be) {
      return this.sources.get(be) * getStressMultiplierForSpeed(be.getGeneratedSpeed());
   }

   public float getActualStressOf(KineticBlockEntity be) {
      return this.members.get(be) * getStressMultiplierForSpeed(be.getTheoreticalSpeed());
   }
