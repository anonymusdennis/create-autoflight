...
public class TransportedItemStackHandlerBehaviour extends BlockEntityBehaviour {
   ...
   public TransportedItemStackHandlerBehaviour(SmartBlockEntity be, TransportedItemStackHandlerBehaviour.ProcessingCallback processingCallback) {
      ...
      this.positionGetter = t -> VecHelper.getCenterOf(be.getBlockPos());
   }
   ...
   public static class TransportedResult {
      ...
      private static final TransportedItemStackHandlerBehaviour.TransportedResult DO_NOTHING = new TransportedItemStackHandlerBehaviour.TransportedResult(
         null, null
      );
      private static final TransportedItemStackHandlerBehaviour.TransportedResult REMOVE_ITEM = new TransportedItemStackHandlerBehaviour.TransportedResult(
      ...
      public static TransportedItemStackHandlerBehaviour.TransportedResult convertToAndLeaveHeld(
      ...
      public boolean didntChangeFrom(ItemStack stackBefore) {
         return this.doesNothing() || this.outputs.size() == 1 && ItemStack.matches(this.outputs.get(0).stack, stackBefore) && !this.hasHeldOutput();
      }
