...
public class ControlsHandler {
   ...
   public static void startControlling(AbstractContraptionEntity entity, BlockPos controllerLocalPos) {
      ...
      Minecraft.getInstance()
         .player
         .displayClientMessage(CreateLang.translateDirect("contraption.controls.start_controlling", entity.getContraptionName()), true);
   }
   ...
   public static void stopControlling() {
      ...
      if (!currentlyPressed.isEmpty() && abstractContraptionEntity != null) {
         CatnipServices.NETWORK.sendToServer(new ControlsInputPacket(currentlyPressed, false, abstractContraptionEntity.getId(), controlsPos, false));
      }
      ...
      controlsPos = null;
      currentlyPressed.clear();
      Minecraft.getInstance().player.displayClientMessage(CreateLang.translateDirect("contraption.controls.stop_controlling"), true);
   }
   ...
   public static void tick() {
      ...
      if (entity != null) {
         ...
         if (!entity.isRemoved() && !InputConstants.isKeyDown(Minecraft.getInstance().getWindow().getWindow(), 256)) {
