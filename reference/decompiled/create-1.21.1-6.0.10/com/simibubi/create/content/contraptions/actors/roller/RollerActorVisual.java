...
public class RollerActorVisual extends HarvesterActorVisual {
   TransformedInstance frame = (TransformedInstance)this.instancerProvider
   ...
   public void beginFrame() {
      ((TransformedInstance)((TransformedInstance)((TransformedInstance)((TransformedInstance)((TransformedInstance)((TransformedInstance)((TransformedInstance)((TransformedInstance)this.harvester
                                 .setIdentityTransform()
                                 .translate(this.context.localPos))
                              .center())
                           .rotateYDegrees(this.horizontalAngle))
                        .uncenter())
                     .translate(0.0, -0.25, 1.0625))
                  .rotateXDegrees((float)this.getRotation()))
               .translate(0.0, -0.5, 0.5))
            .rotateYDegrees(90.0F))
         .setChanged();
      ((TransformedInstance)((TransformedInstance)((TransformedInstance)((TransformedInstance)this.frame
                     .setIdentityTransform()
                     .translate(this.context.localPos))
                  .center())
               .rotateYDegrees(this.horizontalAngle + 180.0F))
            .uncenter())
         .setChanged();
   }
