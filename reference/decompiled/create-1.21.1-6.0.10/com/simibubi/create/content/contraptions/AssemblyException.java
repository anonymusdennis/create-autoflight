...
public class AssemblyException extends Exception {
   ...
   public static void write(CompoundTag compound, Provider registries, AssemblyException exception) {
      if (exception != null) {
         CompoundTag nbt = new CompoundTag();
         nbt.putString("Component", Serializer.toJson(exception.component, registries));
   ...
   public static AssemblyException read(CompoundTag compound, Provider registries) {
      if (!compound.contains("LastException")) {
         ...
         AssemblyException exception = new AssemblyException(Serializer.fromJson(string, registries));
