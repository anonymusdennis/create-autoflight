...
public class FactoryPanelSetItemMenu extends GhostItemMenu<FactoryPanelBehaviour> {
   ...
   protected FactoryPanelBehaviour createOnClient(RegistryFriendlyByteBuf extraData) {
      FactoryPanelPosition pos = (FactoryPanelPosition)FactoryPanelPosition.STREAM_CODEC.decode(extraData);
   ...
   protected void addSlots() {
      ...
      this.addSlot(new SlotItemHandler(this.ghostInventory, 0, slotX, slotY));
   }
