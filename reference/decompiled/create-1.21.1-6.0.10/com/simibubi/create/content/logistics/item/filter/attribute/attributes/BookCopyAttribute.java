...
public record BookCopyAttribute(int generation) implements ItemAttribute {
   ...
   private static int extractGeneration(ItemStack stack) {
      return stack.has(DataComponents.WRITTEN_BOOK_CONTENT) ? ((WrittenBookContent)stack.get(DataComponents.WRITTEN_BOOK_CONTENT)).generation() : -1;
   }
   ...
   public static class Type implements ItemAttributeType {
      ...
      public MapCodec<? extends ItemAttribute> codec() {
         return BookCopyAttribute.CODEC;
      }

      @Override
      public StreamCodec<? super RegistryFriendlyByteBuf, ? extends ItemAttribute> streamCodec() {
         return BookCopyAttribute.STREAM_CODEC;
      }
   }
}
