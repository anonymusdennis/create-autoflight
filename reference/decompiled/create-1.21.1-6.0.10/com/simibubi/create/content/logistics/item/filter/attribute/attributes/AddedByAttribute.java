...
public record AddedByAttribute(String modId) implements ItemAttribute {
   ...
   public Object[] getTranslationParameters() {
      ...
      String name = modContainerById.map(ModContainer::getModInfo).<String>map(IModInfo::getDisplayName).orElse(StringUtils.capitalize(this.modId));
   ...
   public static class Type implements ItemAttributeType {
      ...
      public MapCodec<? extends ItemAttribute> codec() {
         return AddedByAttribute.CODEC;
      }

      @Override
      public StreamCodec<? super RegistryFriendlyByteBuf, ? extends ItemAttribute> streamCodec() {
         return AddedByAttribute.STREAM_CODEC;
      }
   }
}
