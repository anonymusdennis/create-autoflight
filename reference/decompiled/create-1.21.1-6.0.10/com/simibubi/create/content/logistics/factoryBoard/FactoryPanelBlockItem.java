...
public class FactoryPanelBlockItem extends LogisticallyLinkedBlockItem {
   ...
   public InteractionResult place(BlockPlaceContext pContext) {
      ...
      if (!isTuned(stack)) {
         ...
         pContext.getPlayer().displayClientMessage(CreateLang.translate("factory_panel.tune_before_placing").component(), true);
   ...
   public static ItemStack fixCtrlCopiedStack(ItemStack stack) {
      if (isTuned(stack) && networkFromStack(stack) == null) {
         CompoundTag bet = ((CustomData)stack.getOrDefault(DataComponents.BLOCK_ENTITY_DATA, CustomData.EMPTY)).copyTag();
