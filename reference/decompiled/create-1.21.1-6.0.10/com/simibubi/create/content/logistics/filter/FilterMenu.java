...
public class FilterMenu extends AbstractFilterMenu {
   ...
   protected ItemStackHandler createGhostInventory() {
      return ((ListFilterItem)AllItems.FILTER.get()).getFilterItemHandler(this.contentHolder);
   }

   protected void initAndReadInventory(ItemStack filterItem) {
      super.initAndReadInventory(filterItem);
      this.respectNBT = (Boolean)filterItem.getOrDefault(AllDataComponents.FILTER_ITEMS_RESPECT_NBT, false);
      this.blacklist = (Boolean)filterItem.getOrDefault(AllDataComponents.FILTER_ITEMS_BLACKLIST, false);
   }

   @Override
   protected void saveData(ItemStack filterItem) {
      super.saveData(filterItem);
      filterItem.set(AllDataComponents.FILTER_ITEMS_RESPECT_NBT, this.respectNBT);
      filterItem.set(AllDataComponents.FILTER_ITEMS_BLACKLIST, this.blacklist);
