...
public class TrackTargetingClient {
   ...
   public static void clientTick() {
      ...
      if (type != null) {
         ...
         if (alreadySelected) {
            ...
            direction = (Boolean)stack.getOrDefault(AllDataComponents.TRACK_TARGETING_ITEM_SELECTED_DIRECTION, false);
      ...
      } else if (!Objects.equal(hovered, lastHovered)
   ...
   public static void render(PoseStack ms, SuperRenderTypeBuffer buffer, Vec3 camera) {
      if (lastLocation != null && lastResult.feedback == null) {
         ...
         TrackTargetingBehaviour.RenderedTrackOverlayType type = lastType == EdgePointType.SIGNAL
