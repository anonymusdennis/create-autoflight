...
public class TrackMaterialFactory {
   ...
   private Ingredient railsIngredient = Ingredient.fromValues(Stream.of(new TagValue(Items.NUGGETS_IRON), new TagValue(CommonMetal.ZINC.nuggets)));
   ...
   public TrackMaterialFactory standardModels() {
      CatnipServices.PLATFORM.executeOnClientOnly(() -> () -> {
            ...
            this.tieModel = PartialModel.of(ResourceLocation.fromNamespaceAndPath(namespace, prefix + "tie"));
            this.leftSegmentModel = PartialModel.of(ResourceLocation.fromNamespaceAndPath(namespace, prefix + "segment_left"));
            this.rightSegmentModel = PartialModel.of(ResourceLocation.fromNamespaceAndPath(namespace, prefix + "segment_right"));
         });
      return this;
   }

   public TrackMaterialFactory customModels(
      Supplier<Supplier<PartialModel>> tieModel, Supplier<Supplier<PartialModel>> leftSegmentModel, Supplier<Supplier<PartialModel>> rightSegmentModel
   ) {
      CatnipServices.PLATFORM.executeOnClientOnly(() -> () -> {
   ...
   public TrackMaterial build() {
      ...
      return new TrackMaterial(
         ...
         this.trackBlock,
         this.particle,
         this.sleeperIngredient,
         this.railsIngredient,
         this.trackType,
         () -> () -> this.modelHolder,
         this.customFactory
      );
