...
public record BezierTrackPointLocation(BlockPos curveTarget, int segment) {
   public static final Codec<BezierTrackPointLocation> CODEC = RecordCodecBuilder.create(
      i -> i.group(
   ...
   public static final StreamCodec<ByteBuf, BezierTrackPointLocation> STREAM_CODEC = StreamCodec.composite(
      BlockPos.STREAM_CODEC, BezierTrackPointLocation::curveTarget, ByteBufCodecs.INT, BezierTrackPointLocation::segment, BezierTrackPointLocation::new
   );
}
