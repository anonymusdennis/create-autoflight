...
public class TrainMigration {
   ...
   public TrackGraphLocation tryMigratingTo(TrackGraph graph) {
      TrackNode node1 = graph.locateNode((TrackNodeLocation)this.locations.getFirst());
      TrackNode node2 = graph.locateNode((TrackNodeLocation)this.locations.getSecond());
      ...
      if (this.curve) {
         ...
         Vec3 prevDirection = ((TrackNodeLocation)this.locations.getSecond())
            .getLocation()
            .subtract(((TrackNodeLocation)this.locations.getFirst()).getLocation())
            .normalize();
