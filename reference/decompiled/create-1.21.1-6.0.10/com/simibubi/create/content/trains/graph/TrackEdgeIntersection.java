...
public class TrackEdgeIntersection {
   ...
   public boolean targets(TrackNodeLocation target1, TrackNodeLocation target2) {
      return target1.equals(this.target.getFirst()) && target2.equals(this.target.getSecond())
         || target1.equals(this.target.getSecond()) && target2.equals(this.target.getFirst());
   }
