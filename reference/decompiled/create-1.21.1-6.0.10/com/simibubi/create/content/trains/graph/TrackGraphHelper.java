...
public class TrackGraphHelper {
   ...
   public static TrackGraphLocation getGraphLocationAt(Level level, BlockPos pos, AxisDirection targetDirection, Vec3 targetAxis) {
      ...
      if (!(trackBlockState.getBlock() instanceof ITrackBlock track)) {
         ...
         TrackNodeLocation location = new TrackNodeLocation(Vec3.atBottomCenterOf(pos).add(0.0, track.getElevationAtCenter(level, pos, trackBlockState), 0.0))
            .in(level);
   ...
   @Nullable
   public static TrackGraphLocation getBezierGraphLocationAt(Level level, BlockPos pos, AxisDirection targetDirection, BezierTrackPointLocation targetBezier) {
