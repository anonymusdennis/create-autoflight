...
public class Schedule {
   ...
   public static <T> List<? extends Component> getTypeOptions(List<Pair<ResourceLocation, T>> list) {
      ...
      return list.stream()
         .<ResourceLocation>map(Pair::getFirst)
   ...
   public static Schedule fromTag(Provider registries, CompoundTag tag) {
      Schedule schedule = new Schedule();
      schedule.entries = NBTHelper.readCompoundList(tag.getList("Entries", 10), t -> ScheduleEntry.fromTag(registries, t));
