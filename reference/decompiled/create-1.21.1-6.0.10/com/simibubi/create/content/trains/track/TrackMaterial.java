...
public class TrackMaterial {
   ...
   public static final TrackMaterial ANDESITE = TrackMaterialFactory.make(Create.asResource("andesite"))
      .lang("Andesite")
   ...
   public TrackMaterial(
      ...
      Supplier<Supplier<TrackMaterial.TrackModelHolder>> modelHolder
   ) {
   ...
   public TrackBlock createBlock(Properties properties) {
   ...
   @OnlyIn(Dist.CLIENT)
   public static record TrackModelHolder(PartialModel tie, PartialModel leftSegment, PartialModel rightSegment) {
      static final TrackMaterial.TrackModelHolder DEFAULT = new TrackMaterial.TrackModelHolder(
         AllPartialModels.TRACK_TIE, AllPartialModels.TRACK_SEGMENT_LEFT, AllPartialModels.TRACK_SEGMENT_RIGHT
      );
   }
   ...
   public static class TrackType {
      ...
      public interface TrackBlockFactory {
         TrackBlock create(Properties var1, TrackMaterial var2);
      }
   }
}
