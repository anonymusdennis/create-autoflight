...
public class BlazeBurnerRenderer extends SafeBlockEntityRenderer<BlazeBurnerBlockEntity> {
   ...
   public static void renderShared(
      ...
      if (drawHat != null) {
         ...
         ((SuperByteBuffer)((SuperByteBuffer)hatBuffer.rotateCentered(horizontalAngle + (float) Math.PI, Direction.UP)).translate(0.5F, 0.0F, 0.5F))
            .light(15728880)
      ...
      if (heatLevel.isAtLeast(BlazeBurnerBlock.HeatLevel.FADING)) {
         ...
         ((SuperByteBuffer)rodsBuffer.translate(0.0F, offset1 + animation + 0.125F, 0.0F))
            .light(15728880)
         ...
         ((SuperByteBuffer)rodsBuffer2.translate(0.0F, offset2 + animation - 0.1875F, 0.0F))
            .light(15728880)
            .renderInto(ms, bufferSource.getBuffer(RenderType.solid()));
      }
   ...
   private static void draw(SuperByteBuffer buffer, float horizontalAngle, PoseStack ms, VertexConsumer vc) {
      ((SuperByteBuffer)buffer.rotateCentered(horizontalAngle, Direction.UP)).light(15728880).renderInto(ms, vc);
   }
}
