...
public class DisplayBoardTarget extends DisplayTarget {
   ...
   public AABB getMultiblockBounds(LevelAccessor level, BlockPos pos) {
      ...
      if (level.getBlockEntity(pos) instanceof FlapDisplayBlockEntity fdbe) {
         ...
         if (controller == null) {
            ...
            return baseShape.move(controller.getBlockPos().subtract(pos))
               .expandTowards(
                  (double)(normal.getX() * (controller.xSize - 1)), (double)(1 - controller.ySize), (double)(normal.getZ() * (controller.xSize - 1))
               );
         }
      } else {
         return baseShape;
