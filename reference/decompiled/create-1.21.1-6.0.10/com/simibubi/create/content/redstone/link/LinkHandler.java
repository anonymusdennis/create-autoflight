                  ...
                  if (!AllItems.WRENCH.isIn(heldItem)) {
                     ...
                     if (fakePlayer) {
                        ...
                        Vec3 localHit = ray.getLocation()
                           ...
                           .add(Vec3.atLowerCornerOf(ray.getDirection().getNormal()).scale(0.25));
                        fakePlayerChoice = localHit.distanceToSqr(behaviour.firstSlot.getLocalOffset(world, pos, blockState))
