...
public class FillLevelDisplaySource extends PercentOrProgressBarDisplaySource {
   ...
   protected Float getProgress(DisplayLinkContext context) {
      return context.getSourceBlockEntity() instanceof ThresholdSwitchBlockEntity tsbe
         ? Math.max(0.0F, (float)(tsbe.currentLevel - tsbe.currentMinLevel) / (float)(tsbe.currentMaxLevel - tsbe.currentMinLevel))
         : null;
   }
