...
public class AllShapes {
   ...
   public static final VoxelShaper ELEVATOR_PULLEY = shape(0.0, 0.0, 0.0, 16.0, 16.0, 2.0)
      .add(0.0, 0.0, 14.0, 16.0, 16.0, 16.0)
      .add(2.0, 0.0, 2.0, 14.0, 14.0, 14.0)
   ...
   public static final VoxelShaper NOZZLE = shape(2.0, 0.0, 2.0, 14.0, 14.0, 14.0)
      .add(1.0, 13.0, 1.0, 15.0, 15.0, 15.0)
      .erase(3.0, 13.0, 3.0, 13.0, 15.0, 13.0)
      .forDirectional();
   ...
   public static final VoxelShaper STOCKPILE_SWITCH = shape(0.0, 0.0, 0.0, 16.0, 2.0, 16.0)
      .add(1.0, 0.0, 1.0, 15.0, 16.0, 15.0)
      .add(0.0, 14.0, 0.0, 16.0, 16.0, 16.0)
      .add(3.0, 3.0, -2.0, 13.0, 13.0, 2.0)
      .forHorizontal(Direction.NORTH);
   public static final VoxelShaper CONTENT_OBSERVER = shape(0.0, 0.0, 0.0, 16.0, 6.0, 16.0)
      .add(1.0, 0.0, 1.0, 15.0, 16.0, 15.0)
      .add(0.0, 14.0, 0.0, 16.0, 16.0, 16.0)
      .add(3.0, 3.0, -2.0, 13.0, 13.0, 2.0)
      .forHorizontal(Direction.NORTH);
   public static final VoxelShaper FUNNEL_COLLISION = shape(0.0, 0.0, 0.0, 16.0, 4.0, 16.0).forDirectional(Direction.UP);
   public static final VoxelShaper BELT_FUNNEL_RETRACTED = shape(2.0, -2.0, 14.0, 14.0, 14.0, 18.0)
      .add(0.0, -5.0, 8.0, 16.0, 16.0, 14.0)
      .forHorizontal(Direction.NORTH);
   public static final VoxelShaper BELT_FUNNEL_EXTENDED = shape(2.0, -2.0, 14.0, 14.0, 14.0, 18.0)
      .add(3.0, -4.0, 10.0, 13.0, 13.0, 14.0)
      .add(2.0, -4.0, 6.0, 14.0, 14.0, 10.0)
      .add(0.0, -5.0, 0.0, 16.0, 16.0, 6.0)
      .forHorizontal(Direction.NORTH);
   public static final VoxelShaper BELT_FUNNEL_PERPENDICULAR = shape(2.0, -2.0, 14.0, 14.0, 14.0, 18.0)
      .add(1.0, 8.0, 12.0, 15.0, 15.0, 14.0)
      .add(0.1, 13.0, 7.0, 15.9, 15.0, 11.0)
      .add(0.1, 9.0, 8.0, 15.9, 13.0, 12.0)
      .add(0.1, 5.0, 9.0, 15.9, 9.0, 13.0)
      .add(0.1, 1.0, 10.0, 15.9, 5.0, 14.0)
      .add(0.1, -3.0, 11.0, 15.9, 1.0, 15.0)
      .forHorizontal(Direction.NORTH);
   public static final VoxelShaper FUNNEL_WALL = shape(2.0, 2.0, 14.0, 14.0, 14.0, 18.0)
      .add(1.0, 8.0, 12.0, 15.0, 15.0, 14.0)
      .add(0.1, 13.0, 7.0, 15.9, 15.0, 11.0)
      .add(0.1, 9.0, 8.0, 15.9, 13.0, 12.0)
      .add(0.1, 5.0, 9.0, 15.9, 9.0, 13.0)
      .add(0.1, 1.0, 10.0, 15.9, 5.0, 14.0)
      .add(0.1, -1.0, 11.0, 15.9, 1.0, 15.0)
      .forHorizontal(Direction.NORTH);
   ...
   public static final VoxelShaper SMART_FLUID_PIPE_FLOOR = shape(4.0, 4.0, 0.0, 12.0, 12.0, 16.0)
      .add(3.0, 3.0, 3.0, 13.0, 13.0, 13.0)
      .add(5.0, 13.0, 3.0, 11.0, 14.0, 11.0)
      .add(5.0, 14.0, 4.0, 11.0, 15.0, 10.0)
      .add(5.0, 15.0, 5.0, 11.0, 16.0, 9.0)
      .add(5.0, 16.0, 6.0, 11.0, 17.0, 8.0)
      .forHorizontal(Direction.SOUTH);
   public static final VoxelShaper SMART_FLUID_PIPE_WALL = shape(4.0, 0.0, 4.0, 12.0, 16.0, 12.0)
      .add(3.0, 3.0, 3.0, 13.0, 13.0, 13.0)
      .add(5.0, 5.0, 13.0, 11.0, 13.0, 14.0)
      .add(5.0, 6.0, 14.0, 11.0, 12.0, 15.0)
      .add(5.0, 7.0, 15.0, 11.0, 11.0, 16.0)
      .add(5.0, 8.0, 16.0, 11.0, 10.0, 17.0)
      .forHorizontal(Direction.SOUTH);
   public static final VoxelShaper SMART_FLUID_PIPE_CEILING = shape(4.0, 4.0, 0.0, 12.0, 12.0, 16.0)
      .add(3.0, 3.0, 3.0, 13.0, 13.0, 13.0)
      .add(5.0, 2.0, 3.0, 11.0, 3.0, 11.0)
      .add(5.0, 1.0, 4.0, 11.0, 2.0, 10.0)
      .add(5.0, 0.0, 5.0, 11.0, 1.0, 9.0)
      .add(5.0, -1.0, 6.0, 11.0, 0.0, 8.0)
      .forHorizontal(Direction.SOUTH);
   public static final VoxelShaper PUMP = shape(2.0, 0.0, 2.0, 14.0, 16.0, 14.0).forDirectional(Direction.UP);
   ...
   public static final VoxelShaper BELL_DOUBLE_WALL = shape(5.0, 5.0, 0.0, 11.0, 11.0, 16.0)
      .add(3.0, 1.0, 3.0, 13.0, 13.0, 13.0)
      .forHorizontal(Direction.SOUTH);
   ...
   public static final VoxelShaper CONTROLS = shape(0.0, 0.0, 6.0, 16.0, 16.0, 16.0).add(0.0, 0.0, 4.0, 16.0, 2.0, 16.0).forHorizontal(Direction.NORTH);
   public static final VoxelShaper CONTROLS_COLLISION = shape(0.0, 0.0, 6.0, 16.0, 16.0, 16.0).forHorizontal(Direction.NORTH);
   public static final VoxelShaper CONTRAPTION_CONTROLS = shape(0.0, 0.0, 6.0, 2.0, 16.0, 16.0)
      .add(14.0, 0.0, 6.0, 16.0, 16.0, 16.0)
      .add(0.0, 0.0, 14.0, 16.0, 16.0, 16.0)
      .add(0.0, 0.0, 6.0, 16.0, 12.0, 16.0)
      .add(0.0, 0.0, 4.0, 16.0, 2.0, 16.0)
      .forHorizontal(Direction.NORTH);
   public static final VoxelShaper CONTRAPTION_CONTROLS_COLLISION = shape(0.0, 0.0, 6.0, 2.0, 16.0, 16.0)
      .add(14.0, 0.0, 6.0, 16.0, 16.0, 16.0)
      .add(0.0, 0.0, 14.0, 16.0, 16.0, 16.0)
      .add(0.0, 0.0, 7.0, 16.0, 12.0, 16.0)
      .forHorizontal(Direction.NORTH);
   ...
   public static final VoxelShaper STOCK_LINK = shape(1.0, 0.0, 1.0, 15.0, 5.0, 15.0).forDirectional();
   public static final VoxelShaper STEAM_ENGINE = shape(1.0, 0.0, 1.0, 15.0, 3.0, 15.0)
      .add(3.0, 0.0, 3.0, 13.0, 15.0, 13.0)
      .add(1.0, 5.0, 4.0, 15.0, 13.0, 12.0)
      .forHorizontalAxis();
   public static final VoxelShaper STEAM_ENGINE_CEILING = shape(1.0, 13.0, 1.0, 15.0, 16.0, 15.0)
      .add(3.0, 1.0, 3.0, 13.0, 16.0, 13.0)
      .add(1.0, 3.0, 4.0, 15.0, 11.0, 12.0)
      .forHorizontalAxis();
   public static final VoxelShaper STEAM_ENGINE_WALL = shape(1.0, 1.0, 0.0, 15.0, 15.0, 3.0)
      .add(3.0, 3.0, 0.0, 13.0, 13.0, 15.0)
      .add(1.0, 4.0, 5.0, 15.0, 12.0, 13.0)
      .forHorizontal(Direction.SOUTH);
   public static final VoxelShaper PLACARD = shape(2.0, 0.0, 2.0, 14.0, 3.0, 14.0).forDirectional(Direction.UP);
   public static final VoxelShaper FACTORY_PANEL_FALLBACK = shape(0.0, 0.0, 0.0, 16.0, 2.0, 16.0).forDirectional(Direction.UP);
   ...
   public static final VoxelShaper DEPLOYER_INTERACTION = shape(CASING_12PX.get(Direction.UP)).add(SIX_VOXEL_POLE.get(Axis.Y)).forDirectional(Direction.UP);
   ...
   public static final VoxelShaper DESK_BELL = shape(3.0, 0.0, 3.0, 13.0, 3.0, 13.0).add(4.0, 0.0, 4.0, 12.0, 9.0, 12.0).forDirectional(Direction.UP);
   public static final VoxelShaper ITEM_HATCH = shape(1.0, 0.0, 0.0, 15.0, 16.0, 2.0)
      .add(2.0, 2.0, 0.0, 14.0, 13.0, 3.8)
      .add(2.0, 4.0, 0.0, 14.0, 11.0, 5.8)
      .add(2.0, 6.0, 0.0, 14.0, 9.0, 7.8)
      .forHorizontal(Direction.SOUTH);
   public static final VoxelShaper POSTBOX = shape(2.0, 0.0, 0.0, 14.0, 14.0, 16.0).forHorizontal(Direction.SOUTH);
   private static final VoxelShape PISTON_HEAD = ((BlockState)((BlockState)Blocks.PISTON_HEAD
            .defaultBlockState()
            .setValue(DirectionalBlock.FACING, Direction.UP))
         .setValue(PistonHeadBlock.SHORT, true))
      .getShape(null, null);
   private static final VoxelShape PISTON_EXTENDED = shape(CASING_12PX.get(Direction.UP)).add(FOUR_VOXEL_POLE.get(Axis.Y)).build();
   ...
   private static final VoxelShape LOGISTICS_TABLE_SLOPE = shape(0.0, 10.0, 10.667, 16.0, 14.0, 15.0)
      .add(0.0, 12.0, 6.333, 16.0, 16.0, 10.667)
      .add(0.0, 14.0, 2.0, 16.0, 18.0, 6.333)
      .build();
   ...
   public static final VoxelShape SCAFFOLD_FULL = shape(SCAFFOLD_HALF)
      .add(0.0, 0.0, 0.0, 2.0, 16.0, 2.0)
      .add(0.0, 0.0, 14.0, 2.0, 16.0, 16.0)
      .add(14.0, 0.0, 0.0, 16.0, 16.0, 2.0)
      .add(14.0, 0.0, 14.0, 16.0, 16.0, 16.0)
      .build();
   ...
   public static final VoxelShape PACKAGE_PORT = shape(0.0, 0.0, 0.0, 16.0, 4.0, 16.0).add(2.0, 2.0, 2.0, 14.0, 14.0, 14.0).build();
   public static final VoxelShape TABLE_CLOTH = shape(-1.0, -9.0, -1.0, 17.0, 1.0, 17.0).build();
   public static final VoxelShape TABLE_CLOTH_OCCLUSION = shape(0.0, 0.0, 0.0, 16.0, 1.0, 16.0).build();
   public static final VoxelShape CHAIN_CONVEYOR_INTERACTION = shape(-10.0, 2.0, 0.0, 26.0, 14.0, 16.0)
      .add(0.0, 2.0, -10.0, 16.0, 14.0, 26.0)
      .add(-5.0, 2.0, -5.0, 21.0, 14.0, 21.0)
      .add(Shapes.block())
      .build();
   public static final VoxelShape TRACK_FALLBACK = shape(0.0, 0.0, 0.0, 16.0, 4.0, 16.0).build();
   public static final VoxelShape BASIN_BLOCK_SHAPE = shape(0.0, 2.0, 0.0, 16.0, 16.0, 16.0)
      .erase(2.0, 2.0, 2.0, 14.0, 16.0, 14.0)
      .add(2.0, 0.0, 2.0, 14.0, 2.0, 14.0)
      .build();
   public static final VoxelShape BASIN_RAYTRACE_SHAPE = shape(0.0, 2.0, 0.0, 16.0, 16.0, 16.0).add(2.0, 0.0, 2.0, 14.0, 2.0, 14.0).build();
   public static final VoxelShape BASIN_COLLISION_SHAPE = shape(0.0, 2.0, 0.0, 16.0, 13.0, 16.0)
      .erase(2.0, 5.0, 2.0, 14.0, 16.0, 14.0)
      .add(2.0, 0.0, 2.0, 14.0, 2.0, 14.0)
      .build();
   ...
   public static final VoxelShape BACKTANK = shape(3.0, 0.0, 3.0, 13.0, 12.0, 13.0).add(SIX_VOXEL_POLE.get(Axis.Y)).build();
   public static final VoxelShape SPEED_CONTROLLER = shape(0.0, 0.0, 0.0, 16.0, 4.0, 16.0)
      .add(1.0, 1.0, 1.0, 15.0, 13.0, 15.0)
      .add(0.0, 8.0, 0.0, 16.0, 14.0, 16.0)
      .build();
   ...
   public static final VoxelShape PULLEY_MAGNET = shape(3.0, -3.0, 3.0, 13.0, 2.0, 13.0).add(FOUR_VOXEL_POLE.get(Direction.UP)).build();
   ...
   public static final VoxelShape MECHANICAL_ARM = shape(2.0, 0.0, 2.0, 14.0, 10.0, 14.0)
      .add(3.0, 0.0, 3.0, 13.0, 14.0, 13.0)
      .add(0.0, 0.0, 0.0, 16.0, 6.0, 16.0)
      .build();
   public static final VoxelShape MECHANICAL_ARM_CEILING = shape(2.0, 6.0, 2.0, 14.0, 16.0, 14.0)
      .add(3.0, 2.0, 3.0, 13.0, 16.0, 13.0)
      .add(0.0, 10.0, 0.0, 16.0, 16.0, 16.0)
      .build();
   ...
   public static final VoxelShape FUNNEL_FLOOR = shape(2.0, -2.0, 2.0, 14.0, 8.0, 14.0)
      .add(1.0, 1.0, 1.0, 15.0, 8.0, 15.0)
      .add(0.0, 4.0, 0.0, 16.0, 10.0, 16.0)
      .build();
   public static final VoxelShape FUNNEL_CEILING = shape(2.0, 8.0, 2.0, 14.0, 18.0, 14.0)
      .add(1.0, 8.0, 1.0, 15.0, 15.0, 15.0)
      .add(0.0, 6.0, 0.0, 16.0, 12.0, 16.0)
      .build();
   public static final VoxelShape STATION = shape(0.0, 0.0, 0.0, 16.0, 2.0, 16.0).add(1.0, 0.0, 1.0, 15.0, 13.0, 15.0).build();
   public static final VoxelShape STOCK_TICKER = shape(1.0, 0.0, 1.0, 15.0, 4.0, 15.0).add(2.0, 0.0, 2.0, 14.0, 16.0, 14.0).build();
   ...
   public static final VoxelShaper TRACK_CROSS_ORTHO_DIAG = shape(TRACK_DIAG.get(Direction.SOUTH))
      .add(TRACK_ORTHO.get(Direction.EAST))
      .forHorizontal(Direction.SOUTH);
   public static final VoxelShaper TRACK_CROSS_DIAG_ORTHO = shape(TRACK_DIAG.get(Direction.SOUTH))
      .add(TRACK_ORTHO.get(Direction.SOUTH))
      .forHorizontal(Direction.SOUTH);
   ...
   public static final VoxelShaper REDSTONE_BRIDGE = shape(VERTICAL_TABLET_SHAPE)
   ...
   public static final VoxelShaper SCHEMATICS_TABLE = shape(4.0, 0.0, 4.0, 12.0, 12.0, 12.0)
      .add(0.0, 11.0, 2.0, 16.0, 14.0, 14.0)
      .forDirectional(Direction.SOUTH);
