...
public class LerpedFloat {
   ...
   public LerpedFloat chaseTimed(double value, int ticks) {
      double diff = value - (double)this.value;
      return this.chase(value, Math.abs(diff / (double)ticks), LerpedFloat.Chaser.LINEAR);
   }
   ...
   public boolean settled() {
      return Mth.equal((double)this.previousValue, (double)this.value)
         && (this.chaseFunction == null || Mth.equal((double)this.value, (double)this.chaseTarget));
   }
