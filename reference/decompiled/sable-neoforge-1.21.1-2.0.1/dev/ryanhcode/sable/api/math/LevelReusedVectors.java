...
public class LevelReusedVectors {
   public final VoxelShape SCAFFOLDING_TOP = Shapes.create(new AABB(0.0, 0.9375, 0.0, 1.0, 1.0, 1.0));
   ...
   public final MutableBlockPos minPos = new MutableBlockPos();
   public final MutableBlockPos maxPos = new MutableBlockPos();
   public final MutableBlockPos maxBlockPos = new MutableBlockPos();
   public final MutableBlockPos offsetPos = new MutableBlockPos();
   ...
   public final Vector3d[] a = new Vector3d[]{
      new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d()
   };
   public final Vector3d[] b = new Vector3d[]{
      new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d(), new Vector3d()
   };
   public final Vector3d[] checks = new Vector3d[]{
      new Vector3d(),
      new Vector3d(),
      new Vector3d(),
      new Vector3d(),
