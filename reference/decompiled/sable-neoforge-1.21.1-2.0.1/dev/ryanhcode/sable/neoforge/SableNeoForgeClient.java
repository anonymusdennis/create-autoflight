...
public final class SableNeoForgeClient {
   public SableNeoForgeClient(ModContainer modContainer, IEventBus modBus) {
      ...
      SableClient.init();
      modContainer.registerConfig(Type.CLIENT, SableClientConfig.SPEC);
      ...
      modBus.addListener(
         event -> event.registerReloadListener(
               (arg, arg2, arg3, arg4, executor, executor2) -> SubLevelRenderDispatcher.get().reload(arg, arg2, arg3, arg4, executor, executor2)
            )
      );
      if (FlywheelCompatNeoForge.FLYWHEEL_LOADED) {
         Sable.LOGGER
            .warn(
               "NOTE: Sable is loaded with Flywheel. Sable contains extensive shader overrides and a full light-storage replacement. Expect this to cause compatibility issues. If issues arise, please report them to the Sable issue tracker ({}) instead of the Flywheel issue tracker.",
