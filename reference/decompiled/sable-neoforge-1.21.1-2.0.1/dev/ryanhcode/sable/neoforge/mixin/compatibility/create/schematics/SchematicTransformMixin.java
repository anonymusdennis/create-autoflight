...
public abstract class SchematicTransformMixin {
   ...
   public Translate<PoseTransformStack> sable$transformFromSublevel(
      PoseTransformStack instance,
      Vec3 vec3,
      Operation<Translate<PoseTransformStack>> original,
      ...
      return instance.translate(
         VecHelper.lerp(pt, this.prevChasingPos, this.chasingPos).subtract(SublevelRenderOffsetHelper.translation(center)).subtract(camera)
      );
   }
}
