...
public class AllBlockEntityTypesMixin implements RedstoneContactBlockEntityTypeGetter {
   ...
   @Unique
   private static final BlockEntityEntry<RedstoneContactBlockEntity> REDSTONE_CONTACT = REGISTRATE.blockEntity(
         "redstone_contact", RedstoneContactBlockEntity::new
      )
