...
public class IntegratedServerMixin implements SableToastableServer {
   ...
   public void sable$reportSubLevelLoadFailure(GlobalSavedSubLevelPointer pointer) {
      SystemToast.addOrUpdate(
         ...
         Component.translatable("sub_level.toast.loadFailure", new Object[]{Component.literal(pointer.toString())}).withStyle(ChatFormatting.RED),
   ...
   public void sable$reportSubLevelSaveFailure(SubLevelData data) {
      SystemToast.addOrUpdate(
         ...
         Component.translatable("sub_level.toast.saveFailure", new Object[]{Component.literal(data.toString())}).withStyle(ChatFormatting.RED),
         Component.translatable("sub_level.toast.checkLog")
      );
   }
   ...
   public void sable$reportSubLevelPhysicsFailure(ServerSubLevel data) {
      SystemToast.addOrUpdate(
         ...
         Component.translatable("sub_level.toast.physicsFailure", new Object[]{Component.literal(data.toString())}).withStyle(ChatFormatting.RED),
