...
public class CameraMixin {
   ...
   private void sable$setPosition(
      Camera instance,
      double x,
      double y,
      double z,
      ...
      if (Sable.HELPER.getTrackingOrVehicleSubLevel(entity) instanceof ClientSubLevel clientSubLevel) {
         double yOffset = (double)Mth.lerp(partialTicks, this.eyeHeightOld, this.eyeHeight);
         ...
         this.sable$startPos.lerp(this.sable$endPos, (double)partialTicks);
