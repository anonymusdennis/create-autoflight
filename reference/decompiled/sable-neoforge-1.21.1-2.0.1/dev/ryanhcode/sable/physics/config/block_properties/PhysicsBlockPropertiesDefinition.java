...
public record PhysicsBlockPropertiesDefinition(
   TagOrElementLocation selector,
   int priority,
   Map<ResourceLocation, Object> properties,
   Optional<Map<BlockStateConditionSet, Map<ResourceLocation, Object>>> overrides
) {
   public static final Codec<Map<ResourceLocation, Object>> PROPERTIES_CODEC = Codec.dispatchedMap(
      ResourceLocation.CODEC, PhysicsBlockPropertyTypes::getPropertyCodec
   );
   public static final Codec<PhysicsBlockPropertiesDefinition> CODEC = RecordCodecBuilder.create(
      i -> i.group(
               ...
               Codec.dispatchedMap(BlockStateConditionSet.CODEC, ignored -> PROPERTIES_CODEC)
                  .optionalFieldOf("overrides")
                  .forGetter(PhysicsBlockPropertiesDefinition::overrides)
            )
