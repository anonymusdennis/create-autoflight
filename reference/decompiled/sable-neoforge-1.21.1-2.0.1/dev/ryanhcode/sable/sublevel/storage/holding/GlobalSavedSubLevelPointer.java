...
public record GlobalSavedSubLevelPointer(ChunkPos chunkPos, short storageIndex, short subLevelIndex) {
   public static final Codec<GlobalSavedSubLevelPointer> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            ...
            .apply(
               Applicative.unbox(instance),
               (chunkX, chunkZ, storage, subLevel) -> new GlobalSavedSubLevelPointer(new ChunkPos(chunkX, chunkZ), storage, subLevel)
            )
   );
   ...
   public String toString() {
      return "global->[chunkPos=" + this.chunkPos + ", storageIndex=" + this.storageIndex + ", subLevelIndex=" + this.subLevelIndex + "]";
   }
}
