...
public final class LevelUniforms extends UniformWriter {
   ...
   public static void update(RenderContext context) {
      ...
      ptr = writeVec4(ptr, (float)skyColor.x, (float)skyColor.y, (float)skyColor.z, 1.0F);
      ptr = writeVec4(ptr, (float)cloudColor.x, (float)cloudColor.y, (float)cloudColor.z, 1.0F);
      ...
      ptr = writeInt(ptr, (int)(levelDay % 2147483647L));
