...
public class BackendArgument implements ArgumentType<Backend> {
   ...
   private static final DynamicCommandExceptionType ERROR_UNKNOWN_BACKEND = new DynamicCommandExceptionType(
      arg -> Component.translatable("argument.flywheel_backend.id.unknown", new Object[]{arg})
   );
